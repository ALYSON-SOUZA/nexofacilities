      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 z-50 h-full w-full max-w-md bg-white shadow-md flex flex-col print:hidden border-l border-slate-200"
          >
            {/* Header */}
            <div className="bg-slate-900 text-white p-4 flex items-center justify-between select-none">
              <div className="flex items-center gap-3">
                <div className="p-1.5 rounded-lg bg-[#3b82f6]/20 flex items-center justify-center">
              ...
              {loading ? (
                ...
                <div className="h-full flex flex-col items-center justify-center py-12 px-6 space-y-4">
                  <div className="relative flex items-center justify-center h-16 w-16">
                    <span className="absolute inline-flex h-full w-full rounded-full bg-[#3b82f6]/20 animate-ping" />
                    <div className="rounded-full bg-slate-900 border border-slate-700/50 h-10 w-10 flex items-center justify-center text-white">
                      <Sparkles className="h-5 w-5 text-[#3b82f6] animate-spin" />
                    </div>
                  </div>
                        ...
                        result.savingSuggestions.map((sug, idx) => (
                          <div key={idx} className="bg-white rounded-xl border border-slate-100 p-3.5 shadow-xs space-y-3">
                            <div className="flex items-start justify-between gap-1.5">
                              ...
                              <span className="shrink-0 inline-flex items-center rounded-md bg-[#3b82f6]/10 border border-[#3b82f6]/20 px-2 py-0.5 text-xs font-black text-[#3b82f6] uppercase">
                        ...
                        result.serviceRecommendations.map((svc, idx) => (
                          <div key={idx} className="bg-white rounded-xl border border-slate-100 p-3.5 shadow-xs space-y-2.5">
                            <h5 className="text-[11.5px] font-black text-slate-900 uppercase tracking-tight flex items-center gap-1.5">
                              <Award className="h-3.5 w-3.5 text-[#3b82f6] shrink-0" />
                              {svc.serviceName}
                            </h5>
                            ...
                            <div className="bg-[#f5f5f5] border border-[#3b82f6]/10 rounded-lg p-2.5">
                              <span className="text-xs font-black uppercase text-[#3b82f6] tracking-wider flex items-center gap-1">
                                <ArrowUpRight className="h-3 w-3" /> Por que faz sentido comprar:
                              </span>
                              <p className="text-xs text-[#0f172a] font-semibold leading-relaxed mt-1">
                                {svc.whyItFits}
                              </p>
                            </div>
                          </div>
