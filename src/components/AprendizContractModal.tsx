  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-2 sm:p-4 overflow-y-auto">
      <div className="bg-[#F4F6FA] dark:bg-slate-950 rounded-2xl shadow-md border border-slate-200 dark:border-slate-800 w-full max-w-6xl max-h-[92vh] flex flex-col overflow-hidden animate-scale-up">
        ...
        <header className="bg-[#0f172a] px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 shrink-0 border-b border-slate-800">
          <div className="text-center sm:text-left">
            <div className="font-bold text-2xl tracking-tight text-white">
              Bellinati<span className="text-[#3b82f6]">Perez</span>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            <div className="flex items-center gap-2 bg-[#3b82f6]/10 border border-[#3b82f6]/30 px-3.5 py-1.5 rounded-full text-xs text-[#3b82f6] tracking-wider uppercase font-black">
              <span className="h-1.5 w-1.5 bg-[#3b82f6] rounded-full animate-ping"></span>
            ...
            <EmojiButton
              ...
              size="sm"
              variant="primary"
              className="bg-[#3b82f6] hover:bg-[#3b82f6]/90 border-[#3b82f6]"
            />
        ...
        {/* STICKY TAB CONTROLS */}
        <div className="bg-[#0f172a] px-6 pb-2 flex gap-4 shrink-0 border-b border-slate-800">
          <button
        ...
        <div className="flex-1 overflow-y-auto">
          {activeTab === "dashboard" ? (
            ...
            <div className="space-y-6">
              ...
              <section className="bg-[#0f172a] px-6 py-8 border-b border-slate-700 text-white relative overflow-hidden">
                ...
                <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">
                  Nossos <span className="text-[#3b82f6] underline decoration-pink-500 decoration-4">Aprendizes</span>
                </h1>
              ...
              <div className="px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  ...
                  <div className="text-3xl font-extrabold text-[#0f172a] dark:text-white mt-1.5">{totalCount.toString().padStart(2, "0")}</div>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  ...
                  <div className="text-3xl font-extrabold text-[#3b82f6] mt-1.5">{adminCount.toString().padStart(2, "0")}</div>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  ...
                  <div className="text-3xl font-extrabold text-[#2563eb] mt-1.5" style={{ color: "var(--magenta)" }}>{servCount.toString().padStart(2, "0")}</div>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  ...
                  <div className="text-lg font-black text-[#0f172a] dark:text-white mt-1.5 truncate">
              ...
              <div className="px-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-100/50 dark:bg-slate-900/60 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-wider transition-all cursor-pointer ${
                          currentStatusFilter === "Ativo"
                            ? "bg-[#0f172a] text-[#3b82f6] dark:bg-[#3b82f6] dark:text-slate-950 shadow-xs"
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-wider transition-all cursor-pointer ${
                          currentStatusFilter === "Inativo"
                            ? "bg-[#0f172a] text-pink-500 dark:bg-[#3b82f6] dark:text-white shadow-xs"
                            : "bg-slate-200 hover:bg-slate-300 dark:bg-slate-800 text-slate-600 dark:text-slate-400"
                        }`}
                      >
                    ...
                    <div className="relative flex-1 max-w-xs sm:ml-auto">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-2.5 py-1.5 text-xs bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg text-slate-850 dark:text-white focus:outline-hidden focus:border-[#3b82f6] font-bold"
                      />
                    </div>
                  </div>
                  ...
                  <div className="text-xs font-black uppercase text-slate-500 tracking-widest border-b border-slate-200 dark:border-slate-800 pb-2 flex items-center justify-between">
                    ...
                    <span className="text-xs font-semibold text-[#3b82f6]">Resultados ({displayedRecords.length})</span>
                  </div>
                            ...
                            <div className={`relative h-20 overflow-hidden shrink-0 ${
                              ...
                              <span className={`absolute top-2.5 right-2.5 text-xs font-black uppercase tracking-widest px-2 py-0.5 rounded-full border ${
                                isInactive
                                  ...
                                  : isAdm 
                                    ? "bg-[#3b82f6]/15 text-[#2563eb] border-[#3b82f6]/40" 
                                    : "bg-[#3b82f6]/10 text-[#2563eb] dark:text-pink-400 border-[#3b82f6]/30"
                              }`}>
                            ...
                            <div className={`p-4 pt-8 flex-1 flex flex-col justify-between ${isLoner ? "sm:col-span-2 sm:pt-4" : ""}`}>
                              <div>
                                <div className={`font-extrabold text-sm ${
                                  isInactive 
                                    ...
                                    : "text-[#0f172a] dark:text-slate-100 group-hover:text-[#3b82f6]"
                              ...
                              <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2">
                                <div className="flex flex-col">
                                  <span className={`text-xs font-extrabold ${isInactive ? "text-red-650" : isAdm ? "text-[#2563eb]" : "text-[#3b82f6]"}`}>
                      ...
                      return (
                        <div key={i} className="space-y-1.5">
                          <div className="flex justify-between items-start">
                            <div>
                              <span className="text-xs font-extrabold text-[#0f172a] dark:text-white block leading-tight">
                            ...
                            <span className={`text-xs font-black ${isAdm ? "text-[#2563eb]" : "text-[#2563eb]"}`}>
                              ~{pct}%
                            </span>
                          </div>
                      ...
                      <div 
                        ...
                        className={`bg-white dark:bg-slate-900 border border-slate-200/85 dark:border-slate-800 rounded-xl p-4 min-h-48 flex flex-col justify-between transition-all hover:shadow-md ${
                          hasClassClass === "has-event-both" 
                            ? "border-t-4 border-l-2 border-[#3b82f6]" 
                            : hasClassClass === "has-event-ciano" 
                              ? "border-t-4 border-[#3b82f6]" 
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="leading-tight">
                                    <div className="text-[#0f172a] dark:text-slate-100 font-extrabold">{p.nomeCompleto.split(" ")[0]}</div>
                                    <div className={`text-xs font-bold mt-0.5 ${isAdm ? "text-[#2563eb]" : "text-[#2563eb]"}`}>
              ...
              <footer className="px-6 py-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs text-slate-500 uppercase font-bold shrink-0">
                ...
                <span className="flex items-center gap-1.5">
                  <span className="h-1 w-5 bg-gradient-to-r from-[#3b82f6] to-[#3b82f6] rounded-sm"></span>
            ...
            <div className="p-6 max-w-4xl mx-auto space-y-6">
              ...
              {/* CONTROL HERO */}
              <div className="bg-[#0f172a] p-5 rounded-xl border border-slate-700 text-white flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex gap-1.5">
                        ...
                        <EmojiButton
                          ...
                          size="sm"
                          variant="primary"
                          className="bg-[#3b82f6] hover:bg-[#3b82f6]/90 border-[#3b82f6] min-h-0 min-w-0 h-9 w-9 p-0 flex items-center justify-center shrink-0"
                        />
                      </div>
                    </div>
