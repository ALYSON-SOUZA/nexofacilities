...
export default function AprendizContractModal({ isOpen, onClose, visualTheme = "light" }: AprendizContractModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-2 sm:p-4 overflow-y-auto font-sans">
        ...
        <header className="bg-[#252A34] px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 shrink-0 border-b border-slate-800">
          <div className="text-center sm:text-left">
            <div className="font-bold text-2xl tracking-tight text-white">
              Bellinati<span className="text-[#08D9D6]">Perez</span>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            <div className="flex items-center gap-2 bg-[#08D9D6]/10 border border-[#08D9D6]/30 px-3.5 py-1.5 rounded-full text-[10px] text-[#08D9D6] tracking-wider uppercase font-black">
              <span className="h-1.5 w-1.5 bg-[#08D9D6] rounded-full animate-ping"></span>
            ...
            <EmojiButton
              ...
              size="sm"
              variant="custom"
              className="p-1.5 hover:bg-slate-800 rounded-full transition-colors text-slate-400 hover:text-white ml-1 min-h-0 min-w-0 h-auto w-auto"
            />
          </div>
        </header>
          ...
          {activeTab === "dashboard" ? (
            ...
            <div className="space-y-6">
              ...
              <section className="bg-[#252A34] px-6 py-8 border-b border-slate-700 text-white relative overflow-hidden">
                <div className="text-[10px] tracking-widest text-slate-400 uppercase font-black mb-1.5">
                  Gestão de Pessoas · Filial Fortaleza · 2024–2028
                </div>
                <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">
                  Nossos <span className="text-[#08D9D6] underline decoration-pink-500 decoration-4">Aprendizes</span>
                </h1>
              ...
              <div className="px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  <div className="absolute top-0 left-0 w-1 h-full bg-[#08D9D6]"></div>
                  <div className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Total de Aprendizes</div>
                  <div className="text-3xl font-extrabold text-[#252A34] dark:text-white mt-1.5">{totalCount.toString().padStart(2, "0")}</div>
                  <div className="text-[10px] text-slate-500 font-semibold mt-1">Filial Fortaleza</div>
                </div>

                {/* Stat 2 */}
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  <div className="absolute top-0 left-0 w-1 h-full bg-[#FF2E63]"></div>
                  <div className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Área Administrativa</div>
                  <div className="text-3xl font-extrabold text-[#FF2E63] mt-1.5">{adminCount.toString().padStart(2, "0")}</div>
                  <div className="text-[10px] text-slate-500 font-semibold mt-1">JAC Arco Adm</div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  ...
                  <div className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Múltiplas Ocupações</div>
                  <div className="text-[10px] text-slate-500 font-semibold mt-1">JAC Qualificação de Serviço</div>
                </div>

                {/* Stat 4 */}
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 relative overflow-hidden shadow-xs hover:-translate-y-0.5 transition-all">
                  <div className="absolute top-0 left-0 w-1 h-full bg-[#252A34]"></div>
                  <div className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Próximo Término</div>
              ...
              <div className="px-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all cursor-pointer ${
                          currentStatusFilter === "Ativo"
                            ? "bg-[#252A34] text-[#08D9D6] dark:bg-[#08D9D6] dark:text-slate-950 shadow-xs"
                  ...
                  <div className="text-xs font-black uppercase text-slate-500 tracking-widest border-b border-slate-200 dark:border-slate-800 pb-2 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-semibold text-[#08D9D6]">Resultados ({displayedRecords.length})</span>
                  </div>
                  ...
                  {displayedRecords.length === 0 ? (
                    <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-8 text-center text-slate-500">
                      ...
                      <p className="text-[10px] text-slate-400 mt-1 uppercase">Tente usar outros termos na busca ou confira o filtro de status.</p>
                    </div>
                  ) : (
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={`relative h-20 overflow-hidden shrink-0 ${
                              ...
                              <span className={`absolute top-2.5 right-2.5 text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border ${
                                isInactive
                                  ? "bg-red-500 text-white border-red-650"
                                  : isAdm 
                                    ? "bg-[#08D9D6]/15 text-[#069e9c] border-[#08D9D6]/40" 
                              ...
                              {/* ID Tag */}
                              {r.id && (
                                <span className="absolute bottom-2.5 right-2.5 text-[8.5px] font-mono font-black text-slate-500 bg-white/60 dark:bg-slate-900/60 px-1.5 py-0.5 rounded-sm">
                                  {r.id}
                                </span>
                              )}
                              ...
                              <div className="absolute -bottom-6 left-4 h-12 w-12 rounded-full border-2 border-white dark:border-slate-900 overflow-hidden shadow-md">
                                <div className={`h-full w-full flex items-center justify-center text-xs font-black text-white ${
                                  isInactive
                                    ...
                                    : isAdm 
                                      ? "bg-gradient-to-tr from-[#069e9c] to-[#08D9D6]" 
                            ...
                            <div className={`p-4 pt-8 flex-1 flex flex-col justify-between ${isLoner ? "sm:col-span-2 sm:pt-4" : ""}`}>
                              <div>
                                ...
                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-wide mt-0.5 line-clamp-1">
                                  {r.cursoAprendizagem}
                                </div>
                                ...
                                <div className="mt-3.5 space-y-1">
                                  ...
                                  {isInactive && r.dataDesligamento && (
                                    <div className="mt-2 text-[9px] text-red-600 dark:text-red-400 font-extrabold flex items-center gap-1.5 uppercase bg-red-50 dark:bg-red-950/40 p-1.5 rounded-lg border border-red-200/50 dark:border-red-900/40">
                              ...
                              <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2">
                                <div className="flex flex-col">
                                  <span className={`text-xs font-extrabold ${isInactive ? "text-red-650" : isAdm ? "text-[#069e9c]" : "text-[#FF2E63]"}`}>
                                    {r.horarioTrabalho || "08:00 às 12:00"}
                                  </span>
                                  <span className="text-[9px] bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-bold px-1.5 py-0.5 rounded-md mt-0.5 max-w-max">
                      ...
                      return (
                        <div key={i} className="space-y-1.5">
                          <div className="flex justify-between items-start">
                            ...
                            <span className={`text-xs font-black ${isAdm ? "text-[#069e9c]" : "text-[#A82047]"}`}>
                              ~{pct}%
                            </span>
                          </div>
                          ...
                          <div className="w-full h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                            <div 
                              className={`h-full rounded-full transition-all duration-500 ${
                                isAdm 
                                  ? "bg-gradient-to-r from-[#08D9D6] to-[#069e9c]" 
                      ...
                      >
                        <div>
                          ...
                          <div className="mt-3.5 space-y-2">
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="leading-tight">
                                    ...
                                    <div className={`text-[9px] font-bold mt-0.5 ${isAdm ? "text-[#069e9c]" : "text-[#A82047]"}`}>
                            ...
                            {pills.length === 0 && (
                              <div className="text-[10px] text-slate-400 font-medium italic mt-4">
                        ...
                        <div className="text-[9px] text-slate-450 uppercase font-black tracking-widest mt-4">
                          BP FORTALEZA
                        </div>
                      </div>
                    );
              ...
              {/* FOOTER */}
              <footer className="px-6 py-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-[10px] text-slate-500 uppercase font-bold shrink-0">
                <span>BELLINATI PEREZ © 2024 · Gestão de Pessoas · Jovem Aprendiz</span>
                <span className="flex items-center gap-1.5">
                  <span className="h-1 w-5 bg-gradient-to-r from-[#08D9D6] to-[#FF2E63] rounded-sm"></span>
            ...
            <div className="p-6 max-w-4xl mx-auto space-y-6">
              ...
              <div className="bg-[#252A34] p-5 rounded-xl border border-slate-700 text-white flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                  <span className="text-[9px] bg-pink-150 text-pink-700 font-extrabold uppercase px-2 py-0.5 rounded-md tracking-wider">
              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl p-5 space-y-3 shadow-xs">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] bg-amber-100 text-amber-800 font-extrabold px-2 py-0.5 rounded-sm uppercase tracking-widest">
                    Gemini 2.5 Flash
                  </span>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl overflow-hidden shadow-xs">
                  <div className="bg-slate-100 dark:bg-slate-850 px-4 py-2 text-[10px] font-black uppercase text-slate-700 dark:text-slate-200 tracking-wider border-b border-slate-200/80 dark:border-slate-800 flex items-center gap-1.5">
                  ...
                  <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Nome Completo do Aprendiz *</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Data de Nascimento *</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Idade (Cálculo Automático) *</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">CPF do Aprendiz *</label>
                      <input
                        type="text"
                        value={formData.cpf}
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">RG do Aprendiz</label>
                      <input
                        type="text"
                        value={formData.rg}
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Telefone do Aprendiz</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">E-mail de Contato</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Nome da Mãe</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Nome do Pai</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">CEP *</label>
                    ...
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Endereço Residencial</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Número</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Complemento</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Bairro</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Cidade</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Estado (UF)</label>
                      <input
                        type="text"
                        value={formData.uf}
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl overflow-hidden shadow-xs">
                  ...
                  <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Nome do Responsável Legal</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Parentesco</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">CPF do Responsável</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">RG do Responsável</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Telefone do Responsável</label>
                      <input
                        type="text"
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl overflow-hidden shadow-xs">
                  ...
                  <div className="p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Instituição de Ensino / Escola</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Curso / Grau</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Turno Escolar</label>
                      <select
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Série / Ano</label>
                      <input
                        type="text"
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl overflow-hidden shadow-xs">
                  ...
                  <div className="p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Data de Admissão *</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Data de Término *</label>
                      <input
                        type="text"
                    ...
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Entidade Qualificadora (e.g. CIEE, SENAC)</label>
                      <input
                        type="text"
                    ...
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Curso de Aprendizagem</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Status do Aprendiz *</label>
                      <select
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Tipo de Ocupação *</label>
                      <select
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Dia Teórica *</label>
                      <select
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Tutor / Supervisor</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Setor de Alocação</label>
                      <input
                        type="text"
                    ...
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Horário de Trabalho (Máx 6h)</label>
                      <input
                        type="text"
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl overflow-hidden shadow-xs">
                  ...
                  <div className="p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Banco</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Agência</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Conta Corrente</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-450 tracking-wider">Chave PIX</label>
                      <input
                        type="text"
                        value={formData.pix}
          ...
          <>
            ...
            {confirmTerminateId && (
              <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-xs flex items-center justify-center z-[100] p-4">
                <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-150 dark:border-slate-800 flex flex-col gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[10.5px] text-slate-450 dark:text-slate-500 font-medium leading-relaxed mt-2">
