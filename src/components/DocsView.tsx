...
export default function DocsView({ onBack, userName, onOpenIntelligentReading }: DocsViewProps) {
  ...
  return (
    <div className="bg-slate-50 flex-1 rounded-xl p-4 lg:p-6 border border-slate-200 shadow-sm flex flex-col animate-fade-in relative overflow-hidden">
      
      {/* Background decoration elements */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-pink-100/30 rounded-full blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#3b82f6]/10 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between pb-5 border-b border-slate-200/80 gap-4 mb-5 shrink-0">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="p-1.5 rounded-lg bg-[#3b82f6] text-slate-900 shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2 self-start md:self-auto">
          {onOpenIntelligentReading && (
            <button
              ...
              className="px-4 py-2 bg-[#3b82f6] hover:bg-pink-600 text-white font-black text-[11px] uppercase tracking-wider rounded-xl shadow-md transition-all cursor-pointer flex items-center gap-1.5 active:scale-95 animate-pulse"
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm flex flex-col gap-3">
            ...
            {uploadMode === "paste" ? (
              <div className="flex flex-col gap-2.5">
                {isUploading ? (
                  <div className="border border-dashed border-[#3b82f6] bg-pink-50/10 rounded-xl p-8 flex flex-col items-center justify-center text-center">
                    <Loader2 className="h-8 w-8 text-[#3b82f6] animate-spin mb-2" />
                    <p className="text-[11px] font-black text-[#3b82f6] uppercase tracking-wider animate-pulse">
                  ...
                  <>
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        className="text-[11px] font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 focus:outline-[#3b82f6] focus:bg-white transition-all"
                      />
                    </div>
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[11px] font-black uppercase text-slate-500 tracking-wider flex items-center justify-between">
                        ...
                        <span className="text-[#3b82f6] text-[11px] animate-pulse">Suporta Ctrl+V de Imagens!</span>
                      </label>
                      <textarea
                        ...
                        className="w-full h-24 text-[11px] font-semibold text-slate-700 bg-slate-50 border border-slate-200 rounded-xl p-3 focus:outline-[#3b82f6] focus:bg-white transition-all resize-none placeholder:text-slate-500 leading-relaxed"
                      />
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 py-2 bg-[#3b82f6] hover:bg-pink-600 disabled:bg-slate-200 disabled:text-slate-500 text-white font-black text-[11px] uppercase tracking-wider rounded-lg shadow-md transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-95"
                      >
              ...
              <div
                ...
                className={`border-2 border-dashed rounded-xl p-6 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                  dragActive 
                    ? "border-[#3b82f6] bg-pink-50/20" 
                    : "border-slate-300 hover:border-[#3b82f6] hover:bg-slate-50/50"
                }`}
              >
                <input
                  type="file"
                ...
                {isUploading ? (
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-[#3b82f6] font-black uppercase tracking-wider mt-1.5">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm flex-1 flex flex-col min-h-0">
            <div className="flex items-center justify-between mb-2.5 shrink-0">
              ...
              <button
                ...
                className="text-[11px] font-black uppercase text-[#3b82f6] hover:text-[#3b82f6] tracking-wider transition-colors cursor-pointer"
              >
                Atualizar Lista
              </button>
            </div>
            ...
            <div className="flex flex-col gap-2 shrink-0 mb-3.5">
              <div className="relative">
                <input
                  ...
                  className="w-full text-[11px] font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded-xl pl-8 pr-8 py-2 focus:outline-none focus:border-[#3b82f6] focus:bg-white transition-all placeholder:text-slate-400"
                />
                ...
                filteredDocuments.map((doc) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5 min-w-0 flex-1">
                      <div className="h-8.5 w-8.5 rounded-lg bg-slate-100 flex items-center justify-center text-slate-500 shrink-0 group-hover:bg-[#3b82f6]/10 group-hover:text-[#3b82f6] transition-colors">
                        <FileText className="h-4 w-4" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h4 className="text-xs font-black text-slate-800 truncate group-hover:text-[#3b82f6] transition-colors">
                          {doc.name}
                        </h4>
            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              <div className="p-3 bg-slate-50/50 border-b border-slate-100 flex flex-wrap items-center justify-between gap-2 shrink-0">
                ...
                <select
                  ...
                  className="text-[11px] font-black text-slate-700 bg-white border border-slate-200 rounded-lg px-2.5 py-1 focus:outline-[#3b82f6] cursor-pointer max-w-[250px]"
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="space-y-2 whitespace-pre-wrap pr-6">
                        {msg.text.split("\n\n").map((para, pIdx) => {
                          if (para.startsWith("### ")) {
                            return <h3 key={pIdx} className="text-xs font-black uppercase text-[#3b82f6] tracking-wide mt-2 first:mt-0">{para.replace("### ", "")}</h3>;
                          }
                        ...
                        <div className="mt-3.5 pt-3 border-t border-slate-200/50">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {msg.citations.map((cite, cIdx) => (
                              <div
                                key={cIdx}
                                className="px-2 py-1 bg-white border border-slate-200 rounded-md text-[11px] text-slate-600 font-bold hover:border-[#3b82f6] transition-all cursor-pointer relative group/cite max-w-[150px] truncate"
                                title={cite.snippet}
                              >
                                {cite.documentName}
                                ...
                                <div className="absolute bottom-full left-0 mb-1 hidden group-hover/cite:block bg-slate-950 text-white text-[11px] p-2.5 rounded-lg shadow-md w-60 z-50 pointer-events-none border border-slate-800 font-medium leading-normal normal-case">
                                  <span className="font-black text-[#3b82f6] uppercase text-[11px] block mb-1">Snippet do Documento:</span>
                                  "{cite.snippet}"
                                </div>
                              </div>
                            ))}
              ...
              <div className="p-3 border-t border-slate-200/80 shrink-0">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-slate-200 px-4 py-2.5 text-xs font-semibold text-slate-950 placeholder:text-slate-400 bg-slate-50 focus:outline-none focus:border-[#3b82f6] focus:bg-white transition-all"
                  />
                  <button
                    onClick={handleSendMessage}
                    disabled={chatLoading || !inputText.trim()}
                    className="px-4 bg-[#3b82f6] hover:bg-pink-600 disabled:bg-slate-200 text-white font-black text-[11px] uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-1 cursor-pointer"
                  >
                    Perguntar
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      className="text-xs font-bold text-slate-700 bg-white border border-slate-200 rounded-xl px-3 py-2 focus:outline-[#3b82f6] cursor-pointer"
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="text-xs font-bold text-slate-700 bg-white border border-slate-200 rounded-xl px-3 py-2 focus:outline-[#3b82f6]"
                    />
                  </div>
                </div>
              ...
              {presentationMarkdown ? (
                <div className="flex-1 flex flex-col gap-3 min-h-[350px]">
                  ...
                  <div className="flex-1 rounded-2xl bg-slate-950 text-slate-200 p-6 shadow-md flex flex-col justify-between relative overflow-hidden min-h-[250px]">
                    ...
                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#3b82f6]/5 rounded-full blur-2xl" />
                    ...
                    <div className="flex-1 flex flex-col justify-center py-4 space-y-3 overflow-y-auto">
                      {slides[currentSlideIndex]?.split("\n").map((line, idx) => {
                        ...
                        if (trimmed.startsWith("## ")) {
                          return (
                            <h2 key={idx} className="text-sm font-black uppercase text-[#3b82f6] tracking-tight border-l-4 border-[#3b82f6] pl-2.5 py-0.5 my-1 leading-tight">
                              {trimmed.replace("## ", "")}
                            </h2>
                          );
                        }
                        if (trimmed.startsWith("- ") || trimmed.startsWith("* ")) {
                          ...
                          return (
                            <div key={idx} className="flex items-start gap-2 pl-1.5 text-xs">
                              <span className="h-1.5 w-1.5 bg-[#3b82f6] rounded-full shrink-0 mt-2" />
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          onClick={() => setCurrentSlideIndex(prev => prev - 1)}
                           className="p-1 rounded-md bg-slate-900 border border-slate-800 hover:border-[#3b82f6] disabled:opacity-35 transition-all text-slate-500 cursor-pointer"
                        >
          ...
          <div className="bg-white rounded-3xl border border-slate-100 max-w-4xl w-full h-[85vh] p-6 shadow-md flex flex-col gap-4 animate-scale-up relative">
            ...
            <div className="border-b border-slate-100 pb-3 shrink-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-sm bg-pink-100 border border-pink-200 text-[#3b82f6] text-[11px] font-black uppercase tracking-wider">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-5 min-h-0">
              ...
              <div className="flex flex-col border border-slate-200 rounded-2xl overflow-hidden bg-slate-50/50">
                ...
                <div className="flex-1 overflow-y-auto p-4 text-xs font-mono font-medium text-slate-600 leading-relaxed whitespace-pre-wrap select-text selection:bg-[#3b82f6]/20">
                  {selectedDoc.extracted_text || "Nenhum texto transcrito."}
                </div>
              </div>

              {/* Right Side: AI summary text */}
              <div className="flex flex-col border border-[#3b82f6]/25 rounded-2xl overflow-hidden bg-pink-50/5">
                <div className="bg-pink-50/30 border-b border-[#3b82f6]/15 px-3.5 py-2.5 flex items-center justify-between shrink-0 select-none">
                  <span className="text-[11px] font-black text-[#3b82f6] uppercase tracking-wider flex items-center gap-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="p-1 bg-white hover:bg-slate-50 rounded-lg text-[#3b82f6] border border-pink-100/80 transition-all flex items-center justify-center cursor-pointer"
                ...
                <div className="flex-1 overflow-y-auto p-4 text-xs font-semibold text-slate-750 leading-relaxed space-y-2 whitespace-pre-wrap select-text selection:bg-[#3b82f6]/20">
                  {/* Render simple markdown styling for the summary */}
                  {selectedDoc.summary?.split("\n\n").map((para, pIdx) => {
                    if (para.startsWith("### ")) {
                      return <h3 key={pIdx} className="text-xs font-black uppercase text-[#3b82f6] tracking-wide border-b border-pink-100 pb-1 mt-3 first:mt-0">{para.replace("### ", "")}</h3>;
                    }
                    if (para.startsWith("- ") || para.startsWith("* ")) {
                      return (
