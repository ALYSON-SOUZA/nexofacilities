...
export default function DocsView({ onBack, userName, onOpenIntelligentReading }: DocsViewProps) {
  ...
  return (
    <div className="bg-slate-50 min-h-[calc(100vh-130px)] rounded-[32px] p-4 lg:p-6 border border-slate-200/80 shadow-md flex flex-col font-sans animate-fade-in relative overflow-hidden">
      
      {/* Background decoration elements */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-pink-100/30 rounded-full blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-cyan-100/30 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between pb-5 border-b border-slate-200/80 gap-4 mb-5 shrink-0">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="p-1.5 rounded-lg bg-[#08D9D6] text-slate-900 shadow-xs">
              <Sparkles className="h-4.5 w-4.5 text-slate-900" />
            </span>
            <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Bellinati Perez Facilities</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2 self-start md:self-auto">
          {onOpenIntelligentReading && (
            <button
              ...
              className="px-4 py-2 bg-[#FF2E63] hover:bg-pink-600 text-white font-black text-[10.5px] uppercase tracking-wider rounded-xl shadow-md transition-all cursor-pointer flex items-center gap-1.5 active:scale-95 animate-pulse"
          ...
          <button
            onClick={onBack}
            className="px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white font-black text-[10.5px] uppercase tracking-wider rounded-xl shadow-md transition-all self-start cursor-pointer active:scale-95"
          >
            Voltar para Cotação
          </button>
        </div>
      ...
      <div className="flex-1 grid grid-cols-1 xl:grid-cols-12 gap-5 min-h-0">
        ...
        <div className="xl:col-span-5 flex flex-col gap-4 min-h-[500px] xl:min-h-0">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-2xs flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5 bg-slate-50 px-2 py-1 rounded-lg border border-slate-200">
                ...
                <span className="text-[8px] font-black text-slate-400 uppercase">Tag:</span>
                <select
                  value={themeTag}
                  onChange={(e) => setThemeTag(e.target.value)}
                  className="bg-transparent text-[10px] font-black text-slate-700 outline-none border-0 cursor-pointer p-0"
                >
            ...
            <div className="flex border border-slate-200/60 bg-slate-50 p-1 rounded-xl shrink-0 select-none">
              <button
                ...
                className={`flex-1 py-1.5 px-3 rounded-lg text-[10px] font-black uppercase tracking-wider text-center transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
                  uploadMode === "file"
                  ...
                  <>
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        className="text-[10px] font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 focus:outline-[#FF2E63] focus:bg-white transition-all"
                      />
                    </div>
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[9px] font-black uppercase text-slate-400 tracking-wider flex items-center justify-between">
                        ...
                        <span className="text-[#FF2E63] text-[8px] animate-pulse">Suporta Ctrl+V de Imagens!</span>
                      </label>
                      <textarea
                        ...
                        className="w-full h-24 text-[11px] font-semibold text-slate-700 bg-slate-50 border border-slate-200 rounded-xl p-3 focus:outline-[#FF2E63] focus:bg-white transition-all resize-none placeholder:text-slate-450 leading-relaxed"
                      />
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-2 bg-slate-100 hover:bg-slate-200 disabled:opacity-50 text-slate-500 font-black text-[9px] uppercase tracking-wider rounded-lg transition-all cursor-pointer"
                      >
                        Limpar
                      </button>
                      <button
                        ...
                        className="flex-1 py-2 bg-[#FF2E63] hover:bg-pink-600 disabled:bg-slate-200 disabled:text-slate-450 text-white font-black text-[10px] uppercase tracking-wider rounded-lg shadow-md transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-95"
                      >
              ...
              <div
                ...
                className={`border-2 border-dashed rounded-xl p-6 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                  dragActive 
                    ...
                    : "border-slate-300 hover:border-[#08D9D6] hover:bg-slate-50/50"
                }`}
              >
                <input
                  type="file"
                ...
                {isUploading ? (
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-[9px] text-slate-400 font-semibold uppercase leading-none">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-[#FF2E63] font-black uppercase tracking-wider mt-1.5">
                        💡 Dica: Você também pode colar imagens (Ctrl+V) aqui!
                      </p>
                    </div>
                    <div className="text-[8px] text-slate-400 font-semibold uppercase mt-1 leading-normal max-w-xs">
            ...
            {uploadError && (
              <div className="p-2.5 bg-rose-50 border border-rose-200 rounded-xl flex items-center gap-2 text-rose-700 text-[10px] font-bold">
          ...
          {/* DOCUMENTS LIST */}
          <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-2xs flex-1 flex flex-col min-h-0">
            <div className="flex items-center justify-between mb-2.5 shrink-0">
              <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider flex items-center gap-1.5">
                <FileText className="h-4 w-4 text-[#08D9D6]" />
                Arquivos do Repositório ({documents.length})
              </h3>
              <button
                onClick={fetchDocuments}
                className="text-[9px] font-black uppercase text-[#08D9D6] hover:text-[#06b2b0] tracking-wider transition-colors cursor-pointer"
              >
                Atualizar Lista
              </button>
            </div>
            ...
            <div className="flex flex-col gap-2 shrink-0 mb-3.5">
              <div className="relative">
                <input
                  ...
                  className="w-full text-[10px] font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded-xl pl-8 pr-8 py-2 focus:outline-none focus:border-[#08D9D6] focus:bg-white transition-all placeholder:text-slate-400"
                />
                <Search className="absolute left-2.5 top-2.5 h-3.5 w-3.5 text-slate-400" />
                {searchTerm && (
                  <button
                    onClick={() => setSearchTerm("")}
                    className="absolute right-2.5 top-2 hover:bg-slate-200/50 rounded-full p-1 text-slate-400 hover:text-slate-600 transition-colors cursor-pointer text-xs"
                  >
                    <X className="h-3 w-3" />
                  </button>
                )}
              ...
              {documents.length > 0 && (
                <div className="flex items-center gap-1 overflow-x-auto pb-1.5 scrollbar-thin select-none max-w-full">
                  <span className="text-[7.5px] font-black uppercase text-slate-400 tracking-wider shrink-0 mr-1">Filtrar:</span>
                  {uniqueTags.map((tag) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-2 py-0.5 rounded-md text-[8.5px] font-black uppercase tracking-wider transition-all cursor-pointer whitespace-nowrap shrink-0 ${
                          isSelected
            ...
            <div className="flex-1 overflow-y-auto divide-y divide-slate-100 pr-1 max-h-[350px] xl:max-h-none">
              {loadingList ? (
                <div className="flex flex-col items-center justify-center py-12 gap-2 text-slate-400">
                  ...
                  <span className="text-[9.5px] font-black uppercase tracking-wider">Carregando Acervo...</span>
                </div>
              ) : documents.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center text-slate-400">
                  ...
                  <p className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider mt-1 leading-normal max-w-xs">
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center text-slate-400">
                  ...
                  <span className="text-[10px] font-black uppercase text-slate-500">Nenhum resultado encontrado</span>
                ...
                filteredDocuments.map((doc) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5 min-w-0 flex-1">
                      <div className="h-8.5 w-8.5 rounded-lg bg-slate-100 flex items-center justify-center text-slate-500 shrink-0 group-hover:bg-[#08D9D6]/10 group-hover:text-[#08D9D6] transition-colors">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                          <span className="px-1.5 py-0.5 rounded-sm bg-slate-100 border border-slate-200 text-[8px] font-black uppercase tracking-wider text-slate-500">
                            {doc.theme_tag}
                          </span>
                    ...
                    <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        ...
                        className="p-1.5 text-slate-400 hover:text-rose-600 rounded-lg hover:bg-rose-50 border border-transparent hover:border-rose-100 transition-all cursor-pointer"
        ...
        <div className="xl:col-span-7 flex flex-col bg-white rounded-2xl border border-slate-200 shadow-2xs overflow-hidden min-h-[550px] xl:min-h-0">
            ...
            <button
              ...
              className={`flex-1 py-3 px-4 font-black text-xs uppercase tracking-wider text-center border-b-2 transition-all cursor-pointer flex items-center justify-center gap-2 ${
                activeTab === "presentation"
                  ? "border-[#08D9D6] text-[#08D9D6] bg-white"
                  : "border-transparent text-slate-400 hover:text-slate-600 hover:bg-slate-100/50"
              }`}
            >
            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              <div className="p-3 bg-slate-50/50 border-b border-slate-100 flex flex-wrap items-center justify-between gap-2 shrink-0">
                ...
                <select
                  ...
                  className="text-[10px] font-black text-slate-700 bg-white border border-slate-200 rounded-lg px-2.5 py-1 focus:outline-[#FF2E63] cursor-pointer max-w-[250px]"
                >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 min-h-[300px]">
                {chatMessages.map((msg) => (
                  ...
                  >
                    <div
                      className={`max-w-[85%] rounded-[20px] p-4 text-xs font-semibold leading-relaxed shadow-3xs relative group/msg ${
                        msg.sender === "user"
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`absolute right-2.5 top-2.5 p-1 rounded-md opacity-0 group-hover/msg:opacity-100 transition-opacity border shadow-2xs cursor-pointer ${
                          msg.sender === "user" 
                      ...
                      {msg.citations && msg.citations.length > 0 && (
                        <div className="mt-3.5 pt-3 border-t border-slate-200/50">
                          <p className="text-[8px] font-black uppercase text-slate-400 tracking-wider mb-1.5">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {msg.citations.map((cite, cIdx) => (
                              <div
                                key={cIdx}
                                className="px-2 py-1 bg-white border border-slate-200 rounded-md text-[9px] text-slate-600 font-bold hover:border-[#08D9D6] transition-all cursor-pointer relative group/cite max-w-[150px] truncate"
                                title={cite.snippet}
                              >
                                {cite.documentName}
                                
                                {/* Hover snippet preview tooltip */}
                                <div className="absolute bottom-full left-0 mb-1 hidden group-hover/cite:block bg-slate-950 text-white text-[8.5px] p-2.5 rounded-lg shadow-xl w-60 z-50 pointer-events-none border border-slate-800 font-medium leading-normal normal-case">
                                  <span className="font-black text-[#08D9D6] uppercase text-[7.5px] block mb-1">Snippet do Documento:</span>
                                  "{cite.snippet}"
                                </div>
                              </div>
                            ))}
                    ...
                    <span className="text-[8.5px] text-slate-400 font-bold uppercase tracking-wider mt-1 px-1">
                ...
                {chatLoading && (
                  <div className="flex items-center gap-2 text-slate-400 text-xs px-2">
                    ...
                    <span className="font-bold uppercase tracking-wider animate-pulse text-[10px]">IA está lendo os documentos de facilities...</span>
                  </div>
                )}
              ...
              <div className="p-2 border-t border-slate-100 bg-slate-50 flex flex-wrap gap-1.5 shrink-0 select-none">
                <button
                  ...
                  className="px-2 py-1 bg-white hover:bg-slate-100 border border-slate-200 rounded-lg text-[9px] font-bold text-slate-600 uppercase tracking-tight transition-colors cursor-pointer"
                >
                  📋 SLAs & Prazos
                </button>
                <button
              ...
              <div className="p-3 border-t border-slate-200/80 shrink-0">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 bg-[#FF2E63] hover:bg-pink-600 disabled:bg-slate-200 text-white font-black text-[10px] uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-1 cursor-pointer"
                  >
                    Perguntar
            ...
            <div className="flex-1 flex flex-col p-4 gap-4 min-h-0 overflow-y-auto">
              <div className="bg-slate-50 rounded-2xl border border-slate-200 p-4 flex flex-col gap-3.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[9px] font-black uppercase text-slate-400">Documento de Origem</label>
                    <select
                      value={presDocId}
                      onChange={(e) => setPresDocId(e.target.value)}
                      className="text-xs font-bold text-slate-700 bg-white border border-slate-200 rounded-xl px-3 py-2 focus:outline-[#08D9D6] cursor-pointer"
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[9px] font-black uppercase text-slate-400">Tópico ou Foco dos Slides</label>
                    <input
                      type="text"
                      value={presTopic}
                      onChange={(e) => setPresTopic(e.target.value)}
                      placeholder="Ex: Análise de Custos de Facilities, Comparativo de Contratos..."
                      className="text-xs font-bold text-slate-700 bg-white border border-slate-200 rounded-xl px-3 py-2 focus:outline-[#08D9D6]"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-slate-900 hover:bg-slate-800 disabled:bg-slate-200 text-white font-black text-[10.5px] uppercase tracking-wider rounded-xl shadow-md transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  {presLoading ? (
                    <>
                      <Loader2 className="h-4 w-4 animate-spin text-[#08D9D6]" />
              ...
              {presentationMarkdown ? (
                <div className="flex-1 flex flex-col gap-3 min-h-[350px]">
                  ...
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 rounded-lg text-[9px] font-black text-slate-600 uppercase tracking-tight flex items-center gap-1 transition-colors cursor-pointer"
                      >
                  ...
                  <div className="flex-1 rounded-2xl bg-slate-950 text-slate-200 p-6 shadow-xl flex flex-col justify-between relative overflow-hidden min-h-[250px]">
                    {/* Futuristic wireframe accent */}
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#08D9D6]/5 rounded-full blur-2xl" />
                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#FF2E63]/5 rounded-full blur-2xl" />

                    {/* Top slide identifier */}
                    <div className="flex items-center justify-between border-b border-slate-800/80 pb-2.5 shrink-0 text-slate-500 text-[8px] font-black uppercase tracking-widest select-none">
                    ...
                    <div className="flex-1 flex flex-col justify-center py-4 space-y-3 overflow-y-auto">
                      {slides[currentSlideIndex]?.split("\n").map((line, idx) => {
                        ...
                        if (trimmed.startsWith("## ")) {
                          return (
                            <h2 key={idx} className="text-sm font-black uppercase text-[#08D9D6] tracking-tight border-l-4 border-[#08D9D6] pl-2.5 py-0.5 my-1 leading-tight">
                              {trimmed.replace("## ", "")}
                            </h2>
                          );
                        }
                        ...
                        if (trimmed.length > 0) {
                          return <p key={idx} className="text-xs text-slate-400 pl-1 leading-relaxed">{trimmed}</p>;
                        }
                        return null;
                      })}
                    </div>
                    ...
                    <div className="border-t border-slate-800/80 pt-3.5 shrink-0 flex items-center justify-between text-slate-500 text-[9px] select-none">
                      <span className="font-bold">Tema: {presTopic || "Insights Gerais"}</span>
                      <div className="flex items-center gap-1.5">
                        <button
                          disabled={currentSlideIndex === 0}
                          onClick={() => setCurrentSlideIndex(prev => prev - 1)}
                          className="p-1 rounded-md bg-slate-900 border border-slate-800 hover:border-[#08D9D6] disabled:opacity-35 transition-all text-slate-450 cursor-pointer"
                        >
                          <ChevronLeft className="h-3.5 w-3.5" />
                        </button>
                        <span className="font-mono text-slate-400 font-bold px-1">
                ...
                <div className="flex-1 flex flex-col items-center justify-center py-20 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50/20 text-center">
                  ...
                  <p className="text-[10px] text-slate-400 font-bold uppercase mt-1 leading-normal max-w-xs">
      ...
      {isDocModalOpen && selectedDoc && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-fade-in text-slate-850">
          <div className="bg-white rounded-3xl border border-slate-100 max-w-4xl w-full h-[85vh] p-6 shadow-2xl flex flex-col gap-4 animate-scale-up relative">
            ...
            <button
              ...
              className="absolute top-4 right-4 p-1.5 rounded-full hover:bg-slate-100 text-slate-450 hover:text-slate-600 transition-colors cursor-pointer"
            >
            ...
            <div className="border-b border-slate-100 pb-3 shrink-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-sm bg-pink-100 border border-pink-200 text-[#FF2E63] text-[9px] font-black uppercase tracking-wider">
                  {selectedDoc.theme_tag}
                </span>
                <span className="text-[9px] font-mono text-slate-400">ID: {selectedDoc.id}</span>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 mt-2 text-[10px] text-slate-500 font-bold uppercase tracking-wider">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-5 min-h-0">
              ...
              <div className="flex flex-col border border-slate-200 rounded-2xl overflow-hidden bg-slate-50/50">
                <div className="bg-slate-100 border-b border-slate-200 px-3.5 py-2.5 flex items-center justify-between shrink-0 select-none">
                  <span className="text-[10px] font-black text-slate-600 uppercase tracking-wider flex items-center gap-1">
                    <FileText className="h-3.5 w-3.5 text-[#08D9D6]" />
                    Transcrição OCR do Documento Original
                  </span>
                </div>
                <div className="flex-1 overflow-y-auto p-4 text-xs font-mono font-medium text-slate-650 leading-relaxed whitespace-pre-wrap select-text selection:bg-[#08D9D6]/20">
              ...
              <div className="flex flex-col border border-[#FF2E63]/25 rounded-2xl overflow-hidden bg-pink-50/5">
                <div className="bg-pink-50/30 border-b border-[#FF2E63]/15 px-3.5 py-2.5 flex items-center justify-between shrink-0 select-none">
                  <span className="text-[10px] font-black text-[#FF2E63] uppercase tracking-wider flex items-center gap-1">
            ...
            <div className="border-t border-slate-100 pt-3 flex items-center justify-between shrink-0 select-none">
              ...
              <button
                ...
                className="px-5 py-2 border border-slate-200 hover:bg-slate-50 font-black text-[10px] uppercase tracking-wider rounded-xl cursor-pointer"
              >
                Fechar Painel
              </button>
            </div>
