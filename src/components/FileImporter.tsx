  ...
  return (
    <div id="smart-import-modal" className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 animate-fade-in">
      <div className="bg-white rounded-[24px] border border-slate-200 shadow-md w-full max-w-6xl max-h-[92vh] flex flex-col overflow-hidden animate-scale-up">
        ...
        <div className="bg-[#1E222B] text-white p-4 flex items-center justify-between border-b-4 border-[#3b82f6] shrink-0">
          <div className="flex items-center gap-2">
            <span className="bg-[#3b82f6] text-white font-black text-[11px] uppercase tracking-wider px-2 py-0.5 rounded-sm flex items-center gap-1 animate-pulse">
          ...
          <button
            onClick={onClose}
            className="p-1 rounded-full bg-slate-800 hover:bg-[#3b82f6] text-slate-300 hover:text-white transition-all cursor-pointer text-xs font-black font-mono px-2.5"
          >
            FECHAR ✕
          </button>
        </div>
...
Item 2: Pano de Chão Alvejado, 4 un, R$ 8,20`}
                    className="w-full h-[150px] p-3 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-slate-50 focus:bg-white text-[11px] font-mono focus:ring-0 focus:outline-[#3b82f6] resize-none"
                  />
                  <button
                    type="button"
            ...
            <div className="p-3 bg-slate-50 rounded-[14px] text-[11px]/relaxed border border-slate-150 font-semibold text-slate-650 leading-relaxed">
              <span className="font-bold flex items-center gap-1 text-slate-950 border-b border-slate-200 pb-1 mb-1.5 text-[11px] uppercase">
                <HelpCircle className="h-3.5 w-3.5 text-[#3b82f6]" /> Regras Integradas (RN01-RN09)
              </span>
              ...
              {auditedSuppliers.length > 0 && (
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="text-[11px] font-black text-[#3b82f6] hover:text-[#2563eb] hover:underline cursor-pointer uppercase flex items-center gap-1"
                  >
            ...
            <div className="flex-1 overflow-y-auto max-h-[440px] p-4 space-y-4 min-h-[300px]">
              {auditedSuppliers.length > 0 ? (
                    ...
                    <div className="p-3 bg-slate-50/80 border-b border-slate-200 flex flex-wrap items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          className="h-4 w-4 rounded-sm text-[#3b82f6] focus:ring-[#3b82f6] cursor-pointer"
                        ...
                        <div className="flex flex-col">
                          <div className="flex items-center gap-1.5">
                            ...
                            <input
                              ...
                              className="text-xs font-black text-slate-900 uppercase focus:outline-hidden border-b border-transparent hover:border-slate-300 focus:border-[#3b82f6] bg-transparent leading-none p-0.5 max-w-[250px]"
                            ...
                            {audSup.isNew ? (
                              ...
                              <span className="bg-[#3b82f6]/10 text-[#0f172a] font-black text-[11px] uppercase px-1.5 py-0.5 rounded-sm tracking-tight border border-[#3b82f6]/20">
                                🏢 Cadastrado (RN01)
                              </span>
                            )}
                          </div>
                          ...
                          <div className="flex flex-wrap gap-x-3 gap-y-1 mt-1 text-[11px] text-slate-450 font-semibold uppercase">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <input
                                ...
                                className="bg-transparent border-b border-transparent hover:border-slate-300 focus:border-[#3b82f6] outline-hidden p-0 font-bold max-w-[100px] text-slate-700"
                            ...
                            >
                              <div className="flex items-center gap-2.5 flex-1 min-w-0">
                                <input
                                  ...
                                  className="h-3.5 w-3.5 rounded-sm text-[#3b82f6] focus:ring-[#3b82f6] cursor-pointer shrink-0"
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex flex-wrap items-center gap-2">
                                    <input
                                      ...
                                      className="font-bold text-slate-800 text-[11px] p-0.5 border-b border-transparent hover:border-slate-300 focus:border-[#3b82f6] outline-hidden bg-transparent flex-1 min-w-[150px]"
                                    />
                                  ...
                                  {audItem.status === "divergent" && audItem.oldPrice !== null && (
                                    <p className="text-[11px] text-slate-500 font-bold mt-1">
                                      Divergência detectada: <span className="line-through text-slate-500">{formatCurrency(audItem.oldPrice)}</span> ➔ <span className="text-[#3b82f6] font-black">{formatCurrency(audItem.unitPrice)}</span> (Valor da Proposta)
                                    </p>
                                  )}
                                </div>
                              </div>
                              ...
                              <div className="flex items-center gap-3 shrink-0 self-end md:self-auto pl-6 md:pl-0">
                                <div className="flex items-center gap-1 text-[11px]">
                                  ...
                                  <input
                                    ...
                                    className="w-10 text-center rounded-sm border border-slate-200 py-0.5 text-[11px] font-extrabold text-[#3b82f6] focus:outline-[#3b82f6]"
                                  />
                                </div>
                                ...
                                <div className="flex items-center gap-1 text-[11px]">
                                  ...
                                  <input
                                    ...
                                    className="w-16 text-center rounded-sm border border-slate-200 py-0.5 text-[11px] font-extrabold text-slate-900 focus:outline-[#3b82f6]"
                                    placeholder="R$ 0,00"
                                  />
                                </div>
                ...
                <div className="h-full flex flex-col items-center justify-center text-center p-12 text-slate-500 my-auto">
                  <Sparkles className="h-10 w-10 text-[#3b82f6] mb-2 animate-bounce" />
            ...
            <div className="bg-slate-100 p-3.5 border-t border-slate-200 flex flex-wrap items-center justify-between gap-3 shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                {auditedSuppliers.length > 0 && (
                  ...
                  >
                    <Table className="h-3.5 w-3.5 text-[#3b82f6]" />
        ...
        {isTableReviewOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/70 backdrop-blur-xs p-2 sm:p-4 print:hidden">
            <div className="bg-white rounded-[24px] border-2 border-[#3b82f6] shadow-md w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden animate-scale-up text-slate-800">
              
              {/* Modal Header */}
              <div className="bg-[#1E222B] text-white p-4 flex items-center justify-between border-b-4 border-[#3b82f6] shrink-0">
                <div className="flex items-center gap-2">
                  <Table className="h-5 w-5 text-[#3b82f6] shrink-0" />
                  <div>
                              ...
                              <tr key={`${audSup.id}-${audItem.id}`} className={`${rowBg} transition-all`}>
                                ...
                                <td className="py-2 px-3 text-center">
                                  <input
                                    ...
                                    onChange={() => handleToggleItemSelection(audSup.id, audItem.id)}
                                    className="h-4 w-4 rounded-sm text-[#3b82f6] focus:ring-[#3b82f6] cursor-pointer mx-auto"
                                  />
                                </td>
                                ...
                                <td className="py-2 px-3">
                                  <div className="flex flex-col gap-0.5">
                                    <input
                                      ...
                                      value={audSup.name}
                                      onChange={(e) => handleSupplierFieldUpdate(audSup.id, "name", e.target.value)}
                                      className="font-black text-slate-900 bg-transparent hover:bg-slate-50 focus:bg-white focus:outline-none p-1 rounded border border-transparent hover:border-slate-300 focus:border-[#3b82f6] uppercase text-[11px] w-full"
                                    />
                                ...
                                <td className="py-2 px-3">
                                  <div className="flex flex-col gap-0.5">
                                    <input
                                      ...
                                      value={audItem.name}
                                      onChange={(e) => handleItemFieldUpdate(audSup.id, audItem.id, "name", e.target.value)}
                                      className="font-bold text-slate-800 bg-transparent hover:bg-slate-50 focus:bg-white focus:outline-none p-1 rounded border border-transparent hover:border-slate-300 focus:border-[#3b82f6] text-[11px] w-full"
                                    />
                                    {audItem.status === "pending" && audItem.reviewReason && (
                                ...
                                <td className="py-2 px-3 text-center">
                                  <input
                                    ...
                                    value={audItem.quantity}
                                    onChange={(e) => handleItemFieldUpdate(audSup.id, audItem.id, "quantity", e.target.value)}
                                    className="w-16 text-center rounded-md border border-slate-200 py-1 text-[11px] font-extrabold text-[#3b82f6] focus:outline-[#3b82f6] bg-white mx-auto"
                                  />
                                </td>
                                ...
                                <td className="py-2 px-3 text-center">
                                  <div className="relative inline-block w-28">
                                    ...
                                    <input
                                      ...
                                      value={audItem.unitPrice || ""}
                                      onChange={(e) => handleItemFieldUpdate(audSup.id, audItem.id, "unitPrice", e.target.value)}
                                      className="w-full text-center pl-5 pr-1 rounded-md border border-slate-200 py-1 text-[11px] font-extrabold text-slate-900 focus:outline-[#3b82f6] bg-white"
                                      placeholder="0,00"
                                    />
                                  </div>
                                </td>
