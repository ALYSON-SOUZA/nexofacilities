      ...
      <div className="bg-[#FAF9F6] w-full max-w-2xl rounded-[32px] border border-slate-200/80 shadow-md relative overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 pb-4 border-b border-slate-150 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-[11px] font-black text-[#3b82f6] uppercase tracking-wider block leading-none">CONECTIVIDADE</span>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="bg-slate-50 border border-slate-150 p-3.5 rounded-xl space-y-1.5">
                <span className="h-5 w-5 rounded-full bg-[#3b82f6]/10 text-[#3b82f6] font-black text-[11px] flex items-center justify-center border border-[#3b82f6]/25">1</span>
              ...
              <div className="bg-slate-50 border border-slate-150 p-3.5 rounded-xl space-y-1.5">
                <span className="h-5 w-5 rounded-full bg-[#3b82f6]/10 text-[#3b82f6] font-black text-[11px] flex items-center justify-center border border-[#3b82f6]/25">2</span>
              ...
              <div className="bg-slate-50 border border-slate-150 p-3.5 rounded-xl space-y-1.5">
                <span className="h-5 w-5 rounded-full bg-[#3b82f6]/10 text-[#3b82f6] font-black text-[11px] flex items-center justify-center border border-[#3b82f6]/25">3</span>
          ...
          <div className="border-t border-slate-200 pt-6 space-y-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-[#3b82f6] hover:bg-[#3b82f6]/90 text-white font-black px-4 py-2 shadow-sm transition-all text-[11px] uppercase cursor-pointer shrink-0"
              >
