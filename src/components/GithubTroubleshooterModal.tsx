      ...
      <div className="bg-[#FAF9F6] w-full max-w-2xl rounded-[32px] border border-slate-200/80 shadow-[0_25px_60px_rgba(0,0,0,0.1)] relative overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 pb-4 border-b border-slate-150 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-[9px] font-black text-[#FF2E63] uppercase tracking-wider block leading-none">CONECTIVIDADE</span>
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-[11.5px] leading-relaxed text-slate-700">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-4 space-y-3.5">
            ...
            <div className="flex items-center gap-3">
              ...
              {testStatus === "testing" && (
                <span className="text-slate-400 font-bold font-mono animate-pulse">Testando canais de autenticação OAuth...</span>
              )}
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="bg-slate-50 border border-slate-150 p-3.5 rounded-xl space-y-1.5">
                <span className="h-5 w-5 rounded-full bg-[#FF2E63]/10 text-[#FF2E63] font-black text-[10px] flex items-center justify-center border border-[#FF2E63]/25">1</span>
              ...
              <div className="bg-slate-50 border border-slate-150 p-3.5 rounded-xl space-y-1.5">
                <span className="h-5 w-5 rounded-full bg-[#FF2E63]/10 text-[#FF2E63] font-black text-[10px] flex items-center justify-center border border-[#FF2E63]/25">2</span>
              ...
              <div className="bg-slate-50 border border-slate-150 p-3.5 rounded-xl space-y-1.5">
                <span className="h-5 w-5 rounded-full bg-[#FF2E63]/10 text-[#FF2E63] font-black text-[10px] flex items-center justify-center border border-[#FF2E63]/25">3</span>
          ...
          <div className="border-t border-slate-200 pt-6 space-y-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-[#FF2E63] hover:bg-[#FF2E63]/90 text-white font-black px-4 py-2 shadow-sm transition-all text-[10.5px] uppercase cursor-pointer shrink-0"
              >
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl flex flex-col md:flex-row items-center gap-4">
              <div className="flex-1 w-full text-center md:text-left">
                <span className="text-[10px] font-black text-slate-400 block uppercase tracking-wide">Restaurar de um Backup</span>
