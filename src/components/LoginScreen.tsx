...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 select-none relative overflow-hidden" style={{ backgroundColor: "#F4F7F9", backgroundImage: "radial-gradient(#d1d5db 0.5px, transparent 0.5px)", backgroundSize: "24px 24px" }}>
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-1">
            ...
            <span className="text-3xl sm:text-4xl font-display font-extrabold tracking-tight text-[#ff2a6d]">
              BP
            </span>
          </div>
          ...
          <div className="p-6 sm:p-8 pl-7 sm:pl-9">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2.5 mb-2">
                <div className="p-2 rounded-lg bg-[rgba(255,42,109,0.05)] text-[#ff2a6d]">
                  <Shield className="h-4 w-4" />
                </div>
                <h2 className="text-base font-display font-bold text-[#111c2e]">
                  Acesso ao Sistema
                </h2>
              </div>
              <p className="text-[12px] text-slate-400 leading-relaxed font-medium pl-9">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5 text-left">
                <label htmlFor="full-name" className="text-[10px] font-bold uppercase tracking-wider text-slate-500 block">
                  NOME
                </label>
              ...
              {/* CPF FIELD */}
              <div className="space-y-1.5 text-left">
                <label htmlFor="user-cpf" className="text-[10px] font-bold uppercase tracking-wider text-slate-500 block">
                  CPF
                </label>
                <div className="relative group">
                  <input
        ...
        {/* Footer */}
        <div className="text-center mt-8 text-[11px] text-slate-400 font-medium tracking-wider uppercase">
