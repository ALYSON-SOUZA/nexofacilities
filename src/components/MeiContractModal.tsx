...
export default function MeiContractModal({ isOpen, onClose, visualTheme = "light" }: MeiContractModalProps) {
  ...
  const colors = {
    ...
    orange: visualTheme === "ultradark" ? "#3b82f6" : "#f39c12",
  ...
  const handleLocalExtract = () => {
    ...
    setFormData({
      ...
      naturalidade,
      naturalidadeUf,
      sexo: sexo as MeiContractData["sexo"],
      grauInstrucao: grauInstrucao as MeiContractData["grauInstrucao"],
      estadoCivil,
      dataCasamento,
      nomeConjuge,
      racaCor: racaCor as MeiContractData["racaCor"],
      funcaoAtividade,
      cpf,
      pis,
      cnpj,
      ...
      <div className="relative bg-white dark:bg-[#1E222B] w-full max-w-5xl rounded-2xl shadow-md flex flex-col overflow-hidden border border-slate-200 dark:border-slate-800 max-h-[92vh]">
        ...
        <div className="flex flex-col md:flex-row overflow-hidden flex-1">
          ...
          <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-3.5 bg-white dark:bg-[#1a1d24] shadow-2xs">
            <h3 className="text-xs font-black tracking-wider uppercase text-[#0f172a] dark:text-[#5fa8c9] flex items-center gap-1.5 mb-2.5">
              <Clipboard className="h-4 w-4 text-[#3b82f6]" />
              Fornecedores Cadastrados
            </h3>

            {/* Search Input */}
            <div className="relative mb-2.5">
              <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-500 dark:text-slate-500" />
              <input
                type="text"
                placeholder="Buscar fornecedor..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-8 pr-2.5 py-1.5 text-xs bg-slate-50 dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-lg focus:outline-hidden focus:ring-1 focus:ring-[#3b82f6] text-slate-700 dark:text-slate-200 font-semibold"
              />
            </div>
            ...
            <div className="border border-slate-200 dark:border-slate-800 rounded-lg bg-white dark:bg-[#13151b] max-h-[140px] overflow-y-auto overflow-x-auto custom-scrollbar">
              <table className="w-full text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-slate-100 dark:bg-[#171a21] text-slate-500 dark:text-slate-400 font-bold uppercase text-xs border-b border-slate-200 dark:border-slate-800 sticky top-0 z-10">
                ...
                <tbody className="divide-y divide-slate-150 dark:divide-slate-850">
                  {filteredSuppliers.map((sup) => (
                    ...
                    >
                      <td className="px-2 py-1.5 font-semibold text-slate-700 dark:text-slate-300">
                        <div className="truncate font-black text-xs text-[#0f172a] dark:text-[#5fa8c9] max-w-[170px]" title={sup.nomeCompleto}>
                          {sup.nomeCompleto}
                        </div>
                        <div className="text-xs text-slate-500 dark:text-slate-500 font-mono mt-0.5">
                          {sup.cpf || "Sem CPF"}
                        </div>
                      </td>
                  ...
                  {filteredSuppliers.length === 0 && (
                    <tr>
                      <td colSpan={2} className="px-2 py-4 text-center text-slate-500 dark:text-slate-500 text-xs">
          ...
          <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-3.5 bg-white dark:bg-[#1a1d24] shadow-2xs flex flex-col min-h-[220px]">
            <h3 className="text-xs font-black tracking-wider uppercase text-[#0f172a] dark:text-[#5fa8c9] flex items-center gap-1.5 mb-2">
            ...
            <textarea
              ...
              className="w-full min-h-[90px] p-2 text-xs bg-slate-50 dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-lg focus:outline-hidden focus:ring-1 focus:ring-[#3b82f6] resize-none text-slate-700 dark:text-slate-200 font-medium"
            />
          ...
          {statusMessage && (
            <div className="p-2 bg-emerald-50 dark:bg-[#0c3c26] border border-emerald-100 dark:border-emerald-900/60 rounded-lg text-xs font-bold text-emerald-800 dark:text-emerald-400 text-center animate-pulse">
              {statusMessage}
            </div>
          )}
        </div>
        ...
        <div className="flex-1 p-5 flex flex-col overflow-y-auto max-h-[70vh] md:max-h-none">
            ...
            >
              ...
              >
                <div 
                  ...
                  className="w-28 bg-slate-100/50 dark:bg-[#13151b] px-3 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0"
                >
                  Nome Completo:
                </div>
                <input
              ...
              >
                ...
                >
                  <div 
                    style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                    className="w-20 bg-slate-100/50 dark:bg-[#13151b] px-3 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0"
                  >
                    Endereço:
                  </div>
                  <input
                ...
                >
                  <div 
                    style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                    className="w-16 bg-slate-100/50 dark:bg-[#13151b] px-3 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0"
                  >
                    Número:
                  </div>
                  <input
              ...
              >
                ...
                >
                  <div 
                    style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                    className="w-12 bg-slate-100/50 dark:bg-[#13151b] px-3 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0"
                  >
                    CEP:
                  </div>
                  <input
                  ...
                  {isSearchingCep && (
                    <div className="absolute right-2 top-1/2 -translate-y-1/2">
                      <RefreshCw className="h-3 w-3 text-[#3b82f6] animate-spin" />
                    </div>
                  )}
                </div>
                <div 
                ...
                >
                  <div 
                    style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                    className="w-14 bg-slate-100/50 dark:bg-[#13151b] px-3 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0"
                  >
                    Cidade:
                  </div>
                  <input
                ...
                <div className="md:col-span-2 flex">
                  <div 
                    style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                    className="w-10 bg-slate-100/50 dark:bg-[#13151b] px-3 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0"
                  >
                    UF:
                  </div>
                  <input
              ...
              >
                ...
                >
                  <div 
                    ...
                    className="font-bold text-xs uppercase mr-2"
                  >
                    Sexo:
                  </div>
                ...
                {[
                  ...
                  <label key={deg} className="flex items-center gap-2 cursor-pointer select-none">
                    <input
                      ...
                      className="text-[#f39c12] focus:ring-[#f39c12] cursor-pointer h-3.5 w-3.5"
                    />
                    <span style={{ color: colors.textMain }} className="text-xs">{deg}</span>
                  </label>
                ))}
              </div>
              ...
              >
                <div 
                  style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                  className="w-32 bg-slate-100/50 dark:bg-[#13151b] px-3 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0"
                >
                  Função / Atividade:
                </div>
                <input
              ...
              >
                <div 
                  ...
                  className="px-3 py-1.5 font-bold text-xs uppercase border-r flex items-center tracking-wider"
                >
                  Documentos
                </div>
                <div 
                  style={{ color: colors.textNavy }}
                  className="px-3 py-1.5 font-bold text-xs uppercase flex items-center tracking-wider"
                >
                  Dados Bancários
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 min-h-[120px] divide-y md:divide-y-0 md:divide-x divide-slate-300 dark:divide-slate-700">
                ...
                <div className="flex flex-col divide-y divide-slate-300 dark:divide-slate-700">
                  ...
                  <div className="grid grid-cols-2 divide-x divide-slate-300 dark:divide-slate-700 h-[40px]">
                    <div className="flex items-center h-full">
                      <div 
                        style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                        className="w-12 bg-slate-100/50 dark:bg-[#13151b] px-2.5 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0 h-full"
                      >
                        CPF:
                      </div>
                      <input
                  ...
                  <div className="flex items-center h-[40px]">
                    <div 
                      style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                      className="w-24 bg-slate-100/50 dark:bg-[#13151b] px-2.5 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0 h-full"
                    >
                      CNPJ (MEI):
                    </div>
                    <input
                ...
                <div className="flex flex-col divide-y divide-slate-300 dark:divide-slate-700">
                  ...
                  <div className="flex items-center h-[40px]">
                    <div 
                      style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                      className="w-16 bg-slate-100/50 dark:bg-[#13151b] px-2.5 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0 h-full"
                    >
                      Banco:
                    </div>
                    <input
                  ...
                  <div className="grid grid-cols-2 divide-x divide-slate-300 dark:divide-slate-700 h-[40px]">
                    ...
                    <div className="flex items-center h-full">
                      <div 
                        style={{ borderRightColor: colors.rowBorder, color: colors.textMuted }}
                        className="w-14 bg-slate-100/50 dark:bg-[#13151b] px-2.5 py-2 flex items-center font-bold text-xs uppercase border-r shrink-0 h-full"
                      >
                        Conta:
                      </div>
                      <input
          ...
          <div className="mt-4 pt-3 border-t border-slate-150 dark:border-slate-800 flex justify-end gap-3 text-slate-500 text-xs font-black uppercase tracking-wider">
