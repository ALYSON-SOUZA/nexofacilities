    ...
    <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 space-y-6 select-none animate-fade-in print:p-0 print:m-0 print:max-w-none print:shadow-none">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-xl sm:text-2xl font-black text-slate-900 flex items-center gap-1.5 leading-tight">
              <Eye className="h-6 w-6 text-[#3b82f6]" /> Ronda & Vistoria Predial
            </h1>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <div className="bg-slate-100 px-3 py-1.5 rounded-full border border-slate-200 text-xs font-bold text-slate-700 flex items-center gap-1.5">
        ...
        <div className="space-y-6 print:hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
            ...
            <div 
              ...
              className="bp-card p-2.5 sm:p-4 flex flex-col justify-between cursor-pointer hover:border-[#3b82f6] hover:scale-[1.01] transition-all group"
            >
              <span className="text-[9px] sm:text-xs font-black uppercase text-slate-500 tracking-wider group-hover:text-[#3b82f6] transition-colors">Rondas</span>
              <div className="flex items-baseline gap-1 sm:gap-1.5 mt-1 sm:mt-2">
                ...
                <span className="text-[9px] sm:text-xs font-bold text-slate-500">vist.</span>
              </div>
              <span className="text-[9px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 flex items-center gap-1 truncate">{stats.rondasThisMonth} no mês <span className="text-[#3b82f6] hidden sm:inline">🔍 ver</span></span>
            </div>
            ...
            <div 
              ...
              className="bp-card p-2.5 sm:p-4 flex flex-col justify-between cursor-pointer hover:border-[#3b82f6] hover:scale-[1.01] transition-all group"
            >
              <span className="text-[9px] sm:text-xs font-black uppercase text-slate-500 tracking-wider group-hover:text-[#3b82f6] transition-colors">Ocorrências</span>
              <div className="grid grid-cols-3 gap-0.5 sm:gap-1 mt-1 sm:mt-2 text-center text-[9px] sm:text-xs font-black">
                <div 
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  className="p-1 sm:p-1.5 bg-red-50 text-[#3b82f6] rounded-lg hover:bg-red-100 transition-colors"
              ...
              <span className="text-[9px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 flex items-center justify-between">
                <span>Total: {stats.totalOccurrences}</span>
                <span className="text-[#3b82f6] font-bold hidden sm:inline">Ver tudo</span>
              </span>
            </div>
            ...
            <div 
              ...
              className="bp-card p-2.5 sm:p-4 flex flex-col justify-between cursor-pointer hover:border-[#3b82f6] hover:scale-[1.01] transition-all group"
            >
              <span className="text-[9px] sm:text-xs font-black uppercase text-slate-500 tracking-wider group-hover:text-[#3b82f6] transition-colors">Chamados</span>
              <div className="flex items-baseline gap-1 sm:gap-1.5 mt-1 sm:mt-2">
                <span className="text-xl sm:text-3xl font-black text-slate-800">{stats.totalChamados}</span>
                <span className="text-[9px] sm:text-xs text-[#3b82f6] font-extrabold">{stats.chamadosAbertos} abertos</span>
              </div>
              <span className="text-[9px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 flex items-center justify-between">
                <span>Concluídos: {stats.chamadosConcluidos}</span>
                <span className="text-[#3b82f6] font-bold hidden sm:inline">🔍 ver</span>
              </span>
            </div>
            ...
            <div 
              ...
              className="bp-card p-2.5 sm:p-4 flex flex-col justify-between cursor-pointer hover:border-[#3b82f6] hover:scale-[1.01] transition-all group"
            >
              <span className="text-[9px] sm:text-xs font-black uppercase text-slate-500 tracking-wider group-hover:text-[#3b82f6] transition-colors">Último Registro</span>
              {stats.lastRonda ? (
                <div className="mt-1 sm:mt-2 text-[10px] sm:text-xs">
                  ...
                  <p className="text-[9px] sm:text-xs text-slate-500 mt-0.5">{new Date(stats.lastRonda.date).toLocaleDateString("pt-BR")}</p>
                </div>
              ) : (
                <p className="text-[9px] sm:text-xs text-slate-500 mt-1 sm:mt-2">Nenhum registro.</p>
              )}
              <span className="text-[9px] sm:text-xs text-[#3b82f6] font-bold mt-0.5 sm:mt-1 flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div key={r.id} className="p-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                        <div className="space-y-1 pr-4 truncate">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full text-xs font-black uppercase">
                              {r.filial}
                            </span>
                          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-3.5 shadow-sm">
                {chamados.length === 0 ? (
                  <p className="text-xs text-slate-500 font-bold text-center py-4">Nenhum chamado de manutenção em aberto.</p>
                ) : (
                      ...
                      <div key={c.id} className="text-xs space-y-1.5 p-3 rounded-xl border border-slate-100 bg-slate-50/50">
                        <div className="flex items-center justify-between">
                          ...
                          <select
                            ...
                            className={`text-xs font-black uppercase tracking-wide rounded-full px-2 py-0.5 border leading-none cursor-pointer focus:outline-hidden ${
                              c.status === "Concluido"
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm space-y-3">
                <span className="block text-xs font-black uppercase text-slate-500 tracking-wider leading-none">Distribuição de Ocorrências</span>
                
                {stats.totalOccurrences === 0 ? (
                  <p className="text-xs text-slate-500 font-bold text-center py-6">Registros insuficientes para gráfico.</p>
                ) : (
                    ...
                    <div className="w-full space-y-2">
                      ...
                      >
                        <div className="flex items-center justify-between text-xs font-bold text-slate-600 mb-0.5">
                          <span className="flex items-center gap-1 group-hover:text-[#3b82f6]"><span className="h-2 w-2 rounded-full bg-[#3b82f6]"></span> Autuação</span>
                          <span>{stats.autuacaoCount} ({Math.round(stats.autuacaoCount / stats.totalOccurrences * 100)}%)</span>
                        </div>
                        <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                          <div className="bg-[#3b82f6] h-full transition-all" style={{ width: `${(stats.autuacaoCount / stats.totalOccurrences) * 100}%` }}></div>
                        </div>
                      </div>
        ...
        <div className="max-w-2xl mx-auto bg-white border border-slate-200 rounded-[24px] overflow-hidden shadow-md print:hidden">
          ...
          <div className="bg-[#0f172a] text-white p-5 flex items-center justify-between">
            <div className="space-y-0.5">
              <span className="text-xs font-black tracking-widest uppercase text-slate-500">Ronda em Andamento</span>
          ...
          <div className="p-6 space-y-6">
            ...
            {wizardStep === "header" && (
              <form onSubmit={handleSaveRondaHeader} className="space-y-5">
                <div className="bg-[#3b82f6]/5 p-4 rounded-2xl border border-[#3b82f6]/10 flex items-start gap-3">
                  <span className="text-xl">📍</span>
                  <div className="space-y-0.5">
                    <p className="text-xs font-black text-[#3b82f6] uppercase tracking-wide">Passo 1: Selecionar Filial para Vistoria</p>
                    <p className="text-xs text-slate-500 font-semibold">Escolha a filial onde a ronda de vistoria está sendo realizada:</p>
                  </div>
                </div>

                <div className="space-y-4">
                  <div className="flex flex-col space-y-1">
                    <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Filial de Vistoria *</label>
                    <select
                      value={newRondaFilial}
                      onChange={(e) => setNewRondaFilial(e.target.value)}
                      className="w-full rounded-xl border border-slate-200 p-3 font-semibold text-xs focus:outline-none focus:ring-1 focus:ring-[#3b82f6] bg-white text-slate-700"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    <div className="bg-slate-50 border border-slate-150 p-3 rounded-xl flex items-center gap-2.5">
                      ...
                      <div className="space-y-0.5">
                        <span className="block text-xs font-black text-slate-500 uppercase tracking-wider">Operador Responsável</span>
                    ...
                    <div className="bg-slate-50 border border-slate-150 p-3 rounded-xl flex items-center gap-2.5">
                      ...
                      <div className="space-y-0.5">
                        <span className="block text-xs font-black text-slate-500 uppercase tracking-wider">Data de Início</span>
            ...
            {wizardStep === "sala_form" && (
              <form onSubmit={handleSaveSalaHeader} className="space-y-5">
                <div className="bg-[#3b82f6]/5 p-4 rounded-2xl border border-[#3b82f6]/10 flex items-start gap-3">
                  <span className="text-xl">🏢</span>
                  <div className="space-y-0.5">
                    <p className="text-xs font-black text-[#3b82f6] uppercase tracking-wide">Passo 2: Identificar a Sala / Andar</p>
                    <p className="text-xs text-slate-500 font-semibold">Informe os detalhes do ambiente físico vistoriado agora:</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col space-y-1">
                    <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Identificação da Sala *</label>
                    <input 
                      type="text" 
                      required
                      ...
                      className="w-full rounded-xl border border-slate-200 p-3 font-semibold text-xs focus:outline-none focus:ring-1 focus:ring-[#3b82f6]"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col space-y-1 relative">
                      <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Gestor da Sala</label>
                      <input 
                        type="text" 
                        ...
                        <div className="absolute top-[100%] left-0 right-0 bg-white border border-slate-200 rounded-xl mt-1 shadow-lg z-10 overflow-hidden divide-y divide-slate-100">
                          {gestorSuggestions.map(col => (
                            <button
                              ...
                              className="w-full text-left p-2.5 hover:bg-slate-50 text-xs font-bold text-slate-700 block"
                            >
                              <span className="block">{col.nome}</span>
                              <span className="block text-xs text-slate-500 font-semibold">{col.funcao} — {col.filial}</span>
                            </button>
                          ))}
                        </div>
                      )}
                    ...
                    <div className="flex flex-col space-y-1 relative">
                      <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Gerente da Carteira</label>
                      <input 
                        type="text" 
            ...
            {wizardStep === "occurrence_form" && (
              <div className="space-y-5">
                ...
                <div className="bg-[#3b82f6]/5 p-4 rounded-2xl border border-[#3b82f6]/10">
                  <span className="text-xs font-black text-[#3b82f6] uppercase tracking-wide block">Ambiente: {currentSalaName}</span>
                  <p className="text-xs text-slate-500 font-bold mt-1">Registre se identificou alguma inconformidade ou problema de manutenção/limpeza nesta sala:</p>
                </div>

                {/* Chips visual choice of classification */}
                <div className="space-y-1.5">
                  <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Tipo de Ocorrência *</label>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Descrição Detalhada *</label>
                  ...
                  {speechError && (
                    <p className="text-xs text-red-600 font-bold">{speechError}</p>
                  )}
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-slate-200 p-3 font-semibold text-xs focus:outline-none focus:ring-1 focus:ring-[#3b82f6] bg-slate-50/20 focus:bg-white transition-all resize-none"
                  />
                </div>

                {/* Image Captures */}
                <div className="space-y-2">
                  <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Anexo Fotográfico (Fotos da Ocorrência)</label>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    ...
                    <label className="border border-dashed border-slate-300 rounded-xl p-3 flex flex-col items-center justify-center gap-1 hover:bg-slate-50 cursor-pointer text-center">
                      ...
                      <span className="text-xs font-black text-slate-600 uppercase">Tirar Foto / Anexar</span>
                      <span className="text-xs text-slate-500 font-bold">Use a câmera do celular/tablet</span>
                      <input 
                        type="file" 
                        multiple 
                        accept="image/*" 
                    ...
                    <div className="border border-slate-200 rounded-xl p-3 flex flex-col justify-center items-center text-center bg-slate-50">
                      <span className="text-lg">📋</span>
                      <span className="text-xs font-black text-slate-600 uppercase">Colar Clipboard (Ctrl+V)</span>
                      <span className="text-xs text-slate-500 font-bold">Basta colar com a área de texto focada</span>
                    </div>
            ...
            {wizardStep === "ask_next_sala" && (
              <div className="text-center py-6 space-y-6">
                ...
                <div className="mx-auto h-12 w-12 rounded-full bg-red-50 text-[#3b82f6] flex items-center justify-center border border-red-100">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="mt-3 inline-block bg-slate-50 border border-slate-150 px-3.5 py-1.5 rounded-full text-xs text-slate-600 font-bold">
                    Total nesta Ronda: <span className="text-[#3b82f6] font-extrabold">{currentRondaSalas.length} sala(s)</span>
                  </div>
                </div>

                <div className="bg-slate-50/50 rounded-2xl p-4 border border-slate-100 text-left max-w-md mx-auto">
                  <p className="text-xs text-slate-500 uppercase font-black tracking-wider text-center">O que deseja fazer agora?</p>
                </div>
        ...
        <div className="max-w-xl mx-auto bg-white border border-slate-200 rounded-[24px] overflow-hidden shadow-md print:hidden">
          ...
          <div className="bg-[#0f172a] text-white p-5 flex items-center justify-between">
            <h2 className="text-sm font-black uppercase tracking-wider flex items-center gap-1">
              <ShieldAlert className="h-5 w-5 text-[#3b82f6]" /> Abertura de Chamado de Manutenção
            </h2>
            <button
              onClick={() => setRondaActiveSubView("dashboard")}
          ...
          <form onSubmit={handleSaveChamado} className="p-6 space-y-5">
            ...
            <div className="flex flex-col space-y-1">
              <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Selecione a Ronda de Origem *</label>
              <select
                value={ticketRondaId}
                onChange={(e) => {
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 p-3 font-semibold text-xs text-slate-800 focus:outline-none focus:ring-1 focus:ring-[#3b82f6]"
              >
            ...
            {ticketRondaId && (
              <div className="flex flex-col space-y-1">
                <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Sala / Andar de Origem *</label>
                <select
                  value={ticketSalaId}
                  onChange={(e) => {
            ...
            {ticketSalaId && (
              <div className="flex flex-col space-y-1">
                <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Inconformidade / Ocorrência de Origem *</label>
                <select
            ...
            <div className="flex flex-col space-y-1">
              <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Ação de Solução Proposta *</label>
              <textarea
                required
                rows={4}
                ...
                className="w-full rounded-xl border border-slate-200 p-3 font-semibold text-xs focus:outline-none focus:ring-1 focus:ring-[#3b82f6] resize-none"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col space-y-1">
                <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Responsável / Supervisor</label>
                <input 
                  type="text"
              ...
              <div className="flex flex-col space-y-1">
                <label className="text-xs font-black uppercase text-slate-500 tracking-wider">Status Inicial</label>
                <select
                  value={ticketStatus}
                  onChange={(e) => setTicketStatus(e.target.value as any)}
                  className="w-full rounded-xl border border-slate-200 bg-white p-3 font-semibold text-xs focus:outline-none focus:ring-1 focus:ring-[#3b82f6]"
                >
                  <option value="Aberto">Aberto</option>
                  <option value="Em andamento">Em andamento</option>
                  <option value="Concluido">Concluído</option>
      ...
      {rondaActiveSubView === "detail_view" && selectedRondaDetail && (
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-[24px] p-6 sm:p-8 space-y-6 shadow-md print:shadow-none print:border-none print:p-0 print:text-xs/tight">
            ...
            <div className="border border-slate-400">
              ...
              <div className="grid grid-cols-4 border-b border-slate-400 bg-[#4D4D4D] text-white p-3 items-center">
                <div className="col-span-1 flex flex-col justify-center">
                  <span className="font-display font-black text-xs sm:text-sm tracking-widest leading-none">Bellinati Perez</span>
                  <span className="text-xs text-slate-300 font-bold uppercase tracking-wider">Facilities & Operações</span>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-slate-400 text-xs font-semibold text-slate-700 bg-slate-50/50">
                <div className="p-2 space-y-0.5">
                  <span className="block text-xs font-bold text-slate-500 uppercase">Data da Vistoria:</span>
                  <span className="font-extrabold text-slate-800">
                    {new Date(selectedRondaDetail.date).toLocaleDateString("pt-BR")}
                  </span>
                </div>
                <div className="p-2 space-y-0.5">
                  <span className="block text-xs font-bold text-slate-500 uppercase">Hora de Início:</span>
                  <span className="font-extrabold text-slate-800">
                    {new Date(selectedRondaDetail.date).toLocaleTimeString("pt-BR")}
                  </span>
                </div>
                <div className="p-2 space-y-0.5">
                  <span className="block text-xs font-bold text-slate-500 uppercase">Filial Responsável:</span>
                  <span className="font-extrabold text-slate-[#3b82f6] uppercase">
                    {selectedRondaDetail.filial}
                  </span>
                </div>
                <div className="p-2 space-y-0.5">
                  <span className="block text-xs font-bold text-slate-500 uppercase">Responsável Operacional:</span>
            ...
            <div className="space-y-1.5">
              <h3 className="text-xs font-black uppercase text-slate-800 tracking-wider underline decoration-[#3b82f6] decoration-2 underline-offset-4">
            ...
            <div className="space-y-2">
              ...
              <div className="overflow-x-auto border border-slate-300 rounded-xl">
                <table className="w-full text-left text-xs border-collapse min-w-[500px]">
                  <thead>
                    <tr className="bg-[#4D4D4D] text-white font-black text-xs uppercase">
                  ...
                  return (
                    <div key={s.id} className="border border-slate-200 rounded-xl p-4 bg-white space-y-3">
                      <div className="border-b pb-2 flex justify-between items-center bg-slate-50 -mx-4 -mt-4 p-3 rounded-t-xl border-slate-200">
                        ...
                        <span className="text-xs text-slate-500 font-bold">Gestor: {s.gestorSala}</span>
                      </div>
                      ...
                      <div className="divide-y divide-slate-100 space-y-3 pt-1">
                        {roomOccs.map((o) => {
                          const badgeColor = 
                            o.type === "autuacao" 
                              ? "bg-red-50 text-[#3b82f6] border-red-200" 
                              : o.type === "limpeza"
                          ...
                          return (
                            <div key={o.id} className="pt-3 first:pt-0 flex flex-col sm:flex-row gap-3">
                              ...
                              <div className="flex-1 space-y-1.5">
                                <div className="flex items-center gap-2">
                                  <span className={`text-xs font-black uppercase px-2 py-0.5 rounded-md border ${badgeColor}`}>
                                    {o.type}
                                  </span>
            ...
            {/* SIGNATURE FIELDS */}
            <div className="pt-12 grid grid-cols-2 gap-8 text-center text-xs font-bold text-slate-500 print:pt-6">
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[85vh] overflow-hidden flex flex-col shadow-md border border-slate-100 animate-scale-up">
            ...
            <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-50">
              <div>
                <span className="bg-[#3b82f6]/10 text-[#3b82f6] font-black text-xs px-2 py-0.5 rounded-md uppercase tracking-wider">
                  Módulo de Consulta Drill-Down
                </span>
                <h3 className="text-lg font-black text-slate-800 flex items-center gap-2 mt-1">
                  <Clipboard className="h-5 w-5 text-[#3b82f6]" /> {drillDownConfig.title}
                </h3>
              </div>
              <button 
                    ...
                    <div key={r.id} className="bg-white border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-slate-300 transition-all">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="bg-slate-100 text-slate-600 font-extrabold text-xs px-2 py-0.5 rounded-full uppercase">
                            {r.filial}
                          </span>
                        </div>
                        ...
                        <p className="text-xs text-[#3b82f6] font-black uppercase tracking-wider">
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          ...
                          className="px-3 py-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-black text-xs uppercase tracking-wider rounded-lg flex items-center gap-1 cursor-pointer transition-colors"
                        >
                      ...
                      <div key={o.id} className="bg-white border border-slate-200 rounded-xl p-4 space-y-3 hover:border-slate-300 transition-all">
                        <div className="flex items-center justify-between flex-wrap gap-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="bg-slate-100 text-slate-600 font-bold text-xs px-2 py-0.5 rounded-full uppercase">
                              {item.rondaFilial}
                            </span>
                        ...
                        <div className="flex items-center justify-between text-xs text-slate-500 font-bold border-t border-slate-100 pt-2.5">
                          ...
                          <div className="flex items-center gap-2">
                            <button 
                              ...
                              className="px-2.5 py-1 bg-slate-100 hover:bg-[#3b82f6]/10 hover:text-[#3b82f6] text-slate-700 rounded-md transition-colors"
                            >
                              + Gerar Chamado
                            </button>
                            <button 
                    ...
                    <div key={c.id} className="bg-white border border-slate-200 rounded-xl p-4 space-y-3 hover:border-slate-300 transition-all">
                      <div className="flex items-center justify-between flex-wrap gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-slate-500 font-bold">Ronda vinculada: {c.rondaId}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                          <select 
                            value={c.status}
                            onChange={(e) => handleUpdateChamadoStatus(c.id, e.target.value as any)}
                            className="text-xs font-black uppercase px-2 py-1 rounded-md border border-slate-200 bg-white focus:border-[#3b82f6] outline-none"
                          >
                            <option value="Aberto">Aberto</option>
                            <option value="Em andamento">Em andamento</option>
                            <option value="Concluido">Concluído</option>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden flex flex-col shadow-md border border-slate-100 animate-scale-up">
            ...
            <div className="p-5 space-y-4">
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">ID da Ronda</label>
              ...
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Filial</label>
                <select 
                  value={editingRonda.filial}
                  onChange={(e) => setEditingRonda({ ...editingRonda, filial: e.target.value })}
                  className="w-full bg-white border border-slate-200 rounded-lg p-2.5 text-xs font-bold text-slate-700 focus:border-[#3b82f6] outline-none"
                >
                  {FILIAIS_OPTIONS.map(opt => <option key={opt} value={opt}>{opt}</option>)}
                </select>
              </div>
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Data/Hora</label>
                <input 
                  type="datetime-local" 
            ...
            <div className="p-4 border-t border-slate-200 flex justify-end gap-2 bg-slate-50">
              ...
              <button onClick={() => handleSaveEditedRonda(editingRonda)} className="px-4 py-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-black text-xs uppercase rounded-lg">Salvar Alterações</button>
            </div>
          </div>
        </div>
      )}
      ...
      {editingSala && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden flex flex-col shadow-md border border-slate-100 animate-scale-up">
            ...
            <div className="p-5 space-y-4">
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Nome do Ambiente / Sala</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Gestor do Ambiente</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Gerente de Carteira</label>
                <input 
                  type="text" 
            ...
            <div className="p-4 border-t border-slate-200 flex justify-end gap-2 bg-slate-50">
              ...
              <button onClick={() => handleSaveEditedSala(editingSala.rondaId, editingSala.sala)} className="px-4 py-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-black text-xs uppercase rounded-lg">Salvar</button>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
            <form onSubmit={(e) => {
              ...
              <div className="p-5 space-y-4">
                <div>
                  <label className="block text-xs font-black uppercase text-slate-500 mb-1">Nome do Ambiente / Sala</label>
                  <input type="text" name="sala" required placeholder="Ex: Recepção principal, Sala de Reunião 2" className="w-full bg-white border border-slate-200 rounded-lg p-2.5 text-xs font-bold text-slate-700 focus:border-[#3b82f6] outline-none" />
                </div>
                <div>
                  <label className="block text-xs font-black uppercase text-slate-500 mb-1">Gestor do Ambiente</label>
                  <input type="text" name="gestor" placeholder="Ex: Maria Rodrigues" className="w-full bg-white border border-slate-200 rounded-lg p-2.5 text-xs font-bold text-slate-700 focus:border-[#3b82f6] outline-none" />
                </div>
                <div>
                  <label className="block text-xs font-black uppercase text-slate-500 mb-1">Gerente de Carteira</label>
                  <input type="text" name="gerente" placeholder="Ex: Diego Machado" className="w-full bg-white border border-slate-200 rounded-lg p-2.5 text-xs font-bold text-slate-700 focus:border-[#3b82f6] outline-none" />
                </div>
              </div>
              <div className="p-4 border-t border-slate-200 flex justify-end gap-2 bg-slate-50">
                ...
                <button type="submit" className="px-4 py-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-black text-xs uppercase rounded-lg">Adicionar</button>
              </div>
            </form>
          </div>
        );
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg overflow-hidden flex flex-col shadow-md border border-slate-100 animate-scale-up">
            <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-50">
              <h3 className="text-sm font-black text-slate-800 uppercase tracking-wide flex items-center gap-1.5">
                <AlertTriangle className="h-4 w-4 text-[#3b82f6]" /> Editar Ocorrência Registrada
              </h3>
            ...
            <div className="p-5 space-y-4 overflow-y-auto max-h-[60vh]">
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Tipo de Ocorrência</label>
                <div className="grid grid-cols-3 gap-2">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="block text-xs font-black uppercase text-slate-500">Descrição Detalhada</label>
                  <button
                    type="button"
                    ...
                    className={`inline-flex items-center gap-1 text-xs font-black uppercase px-2.5 py-1 rounded-md transition-colors ${
                ...
                {speechError && (
                  <p className="text-xs font-bold text-red-500 mb-2 bg-red-50 p-2 rounded-lg border border-red-100">{speechError}</p>
                )}
                ...
                <textarea
                  ...
                  className="w-full bg-white border border-slate-200 rounded-xl p-3 text-xs font-semibold text-slate-700 focus:border-[#3b82f6] outline-none"
                />
                <span className="block text-xs text-slate-500 font-semibold mt-1">Dica: Cole um arquivo de imagem direto na caixa acima para anexar.</span>
              </div>

              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1.5">Fotos Anexadas ({editingOccurrence.occurrence.images.length})</label>
            ...
            <div className="p-4 border-t border-slate-200 flex justify-end gap-2 bg-slate-50">
              ...
              <button onClick={() => handleSaveEditedOccurrence(editingOccurrence.rondaId, editingOccurrence.salaId, editingOccurrence.occurrence)} className="px-4 py-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-black text-xs uppercase rounded-lg">Salvar Ocorrência</button>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl w-full max-w-lg overflow-hidden flex flex-col shadow-md border border-slate-100 animate-scale-up">
              ...
              <div className="p-5 space-y-4 overflow-y-auto max-h-[60vh]">
                ...
                <div>
                  <label className="block text-xs font-black uppercase text-slate-500 mb-1.5">Fotos Anexadas ({occImages.length})</label>
              ...
              <div className="p-4 border-t border-slate-200 flex justify-end gap-2 bg-slate-50">
                ...
                <button type="submit" className="px-4 py-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-black text-xs uppercase rounded-lg">Registrar</button>
              </div>
            </form>
          </div>
        );
      ...
      {editingChamado && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden flex flex-col shadow-md border border-slate-100 animate-scale-up">
            ...
            <div className="p-5 space-y-4">
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Ação Corretiva Proposta</label>
                <textarea 
                  value={editingChamado.description} 
                  onChange={(e) => setEditingChamado({ ...editingChamado, description: e.target.value })}
                  rows={3}
                  className="w-full bg-white border border-slate-200 rounded-lg p-2.5 text-xs font-semibold text-slate-700 focus:border-[#3b82f6] outline-none" 
                />
              </div>
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-1">Responsável pela Resolução</label>
                <input 
                  type="text" 
            ...
            <div className="p-4 border-t border-slate-200 flex justify-end gap-2 bg-slate-50">
              ...
              <button onClick={() => handleSaveEditedChamado(editingChamado)} className="px-4 py-1.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-black text-xs uppercase rounded-lg">Salvar</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showPrintModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-fade-in print:hidden">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-md border-2 border-[#3b82f6] flex flex-col gap-5 animate-scale-in text-slate-800 relative">
            <button 
            ...
            <div className="text-center space-y-1.5">
              <div className="h-11 w-11 rounded-full bg-red-50 flex items-center justify-center text-[#3b82f6] mx-auto border border-red-100 animate-pulse">
            ...
            <div className="space-y-3 text-xs text-slate-600 leading-relaxed font-semibold">
              ...
              <p className="p-2.5 rounded-xl border border-red-100 bg-red-50/40 text-[#3b82f6] font-bold">
              ...
              <div className="space-y-2.5 pl-1.5 list-none">
                <div className="flex items-start gap-2">
                  <span className="h-4 w-4 rounded-full bg-slate-150 flex items-center justify-center text-slate-600 text-xs font-bold shrink-0 mt-0.5">1</span>
                  <p>
                ...
                <div className="flex items-start gap-2">
                  <span className="h-4 w-4 rounded-full bg-slate-150 flex items-center justify-center text-slate-600 text-xs font-bold shrink-0 mt-0.5">2</span>
                  <p>
              ...
              <div className="flex flex-col gap-2 pt-2 border-t border-slate-100">
                <a
                  ...
                  rel="noreferrer"
                  onClick={() => setShowPrintModal(false)}
                  className="inline-flex items-center justify-center gap-1.5 rounded-full bg-[#3b82f6] hover:bg-[#2563eb] text-white py-3 text-xs font-black tracking-wider uppercase shadow-md hover:shadow-lg transition-all cursor-pointer text-center"
                >
