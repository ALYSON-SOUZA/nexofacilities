...
export default function StockControl({ onBack, capacityRows, categories, setCategories, onExportToQuotation }: StockControlProps) {
    ...
    if (idx > 0) {
      ...
      if (prevTotalStock > 0) {
        ...
        if (pct > 0) {
          ...
          variationText = `${pct.toFixed(1)}% Vol`;
          variationColor = "text-[#0f172a] bg-[#3b82f6]/10 border border-[#3b82f6]/15";
        } else {
  ...
  return (
    <div className="bg-slate-50 text-slate-800 animate-fade-in leading-normal">
      ...
      <div className="showcase-card p-3 sm:p-4 px-4 sm:px-6 flex flex-wrap sm:flex-nowrap justify-between items-start sm:items-center gap-3 print:hidden mb-4 sm:mb-6">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          <button 
            onClick={onBack}
            className="p-1.5 sm:p-2 bg-slate-100 hover:bg-slate-200 rounded-full transition-transform active:scale-95 text-[#3b82f6] hover:text-[#3b82f6]/80 cursor-pointer shrink-0"
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="text-[9px] sm:text-[10px] font-extrabold uppercase tracking-widest bg-[#3b82f6]/8 text-[#3b82f6] border border-[#3b82f6]/15 px-1.5 sm:px-2 py-0.5 rounded-sm">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-1 sm:gap-1.5 rounded-full bg-[#3b82f6] hover:bg-pink-600 px-2.5 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs font-black uppercase text-white shadow-md hover:shadow-lg transition-all active:scale-95 cursor-pointer leading-none"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-12 gap-4 mb-6 print:hidden">
        ...
        <div className="col-span-2 lg:col-span-6 relative bp-card p-4 sm:p-5 transition-all flex flex-col justify-between overflow-hidden">
          <div className="flex items-start justify-between gap-1">
            <div className="space-y-1">
              <div className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-pink-50 text-[#3b82f6] shrink-0 border border-pink-100">
                <CalendarDays className="h-4 w-4" />
              </div>
              <span className="text-xs font-black uppercase tracking-wider text-[#3b82f6] block leading-none font-display">
                Última Contagem
              </span>
            </div>
          </div>
          <div className="mt-4">
            <span className="text-xl lg:text-[22px] xl:text-[24px] font-black text-[#0f172a] block truncate font-display tracking-tight leading-none">
          ...
          <div className="absolute -bottom-6 -right-6 w-12 h-12 rounded-full bg-[#3b82f6]/5 blur-xs pointer-events-none" />
        </div>

        {/* Card 2: Consumer Capacity -> Petroleum Blue (#0f172a) */}
        <div className="col-span-1 lg:col-span-2 relative bp-card p-4 transition-all flex flex-col justify-between overflow-hidden">
          <div className="flex items-start justify-between gap-1">
            <div className="space-y-1">
              <div className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#0f172a]/5 text-[#0f172a] shrink-0 border border-[#0f172a]/15">
                <Users className="h-4 w-4" />
              </div>
              <span className="text-xs font-black uppercase tracking-wider text-[#0f172a] block leading-none font-display">
                Capacity Vigente
              </span>
            </div>
            <span className="inline-flex items-center rounded-full bg-[#0f172a]/10 px-1.5 py-0.5 text-xs font-black text-[#0f172a] uppercase border border-[#0f172a]/20 print:hidden shrink-0">
              Profissionais
            </span>
          </div>
          <div className="mt-4">
            <span className="text-xl lg:text-[22px] xl:text-[24px] font-black text-[#0f172a] block font-display tracking-tight leading-none">
          ...
          <div className="absolute -bottom-6 -right-6 w-12 h-12 rounded-full bg-[#0f172a]/5 blur-xs pointer-events-none" />
        </div>
        ...
        <div className="col-span-1 lg:col-span-2 relative bp-card p-4 transition-all flex flex-col justify-between overflow-hidden">
          <div className="flex items-start justify-between gap-1">
            <div className="space-y-1">
              <div className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#3b82f6]/10 text-[#3b82f6] shrink-0 border border-[#3b82f6]/20">
                <TrendingDown className="h-4 w-4" />
              </div>
              <span className="text-xs font-black uppercase tracking-wider text-[#2563eb] block leading-none font-display truncate max-w-[150px]">
                Total Estocado ({activeCategory.name})
              </span>
            </div>
          </div>
          <div className="mt-4">
            <span className="text-xl lg:text-[22px] xl:text-[24px] font-black text-[#2563eb] block font-display tracking-tight leading-none">
          ...
          <div className="absolute -bottom-6 -right-6 w-12 h-12 rounded-full bg-[#3b82f6]/10 blur-xs pointer-events-none" />
        </div>

        {/* Card 4: Consumption per Capita -> Magenta (#2563eb) */}
        <div className="col-span-1 lg:col-span-2 relative bp-card p-4 transition-all flex flex-col justify-between overflow-hidden">
          <div className="flex items-start justify-between gap-1">
            <div className="space-y-1">
              <div className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#2563eb]/10 text-[#2563eb] shrink-0 border border-[#2563eb]/20">
                <BarChart3 className="h-4 w-4" />
              </div>
              <span className="text-xs font-black uppercase tracking-wider text-[#2563eb] block leading-none font-display">
          ...
          <div className="mt-4">
            {reportMeasurements.length < 2 ? (
              <>
                <span className="text-xs font-black text-[#2563eb] block uppercase tracking-tight font-display leading-none">
                  Mínimo 2 Contagens
                </span>
                <span className="text-xs font-bold text-slate-500 mt-1.5 block leading-normal">
          ...
          <div className="absolute -bottom-6 -right-6 w-12 h-12 rounded-full bg-[#2563eb]/10 blur-xs pointer-events-none" />
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-3xs mb-6 print:hidden">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 bg-pink-50 rounded-xl flex items-center justify-center text-[#3b82f6] border border-pink-100 shrink-0">
              <Layers className="h-5 w-5" />
            </div>
            <div>
              <span className="text-xs font-black uppercase tracking-wider text-[#3b82f6] block">Categoria para Controle</span>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-1 md:max-w-2xl justify-end">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-[#0f172a] hover:bg-slate-800 text-white px-4 py-2.5 text-xs font-black uppercase transition-all shadow-md active:scale-95 cursor-pointer shrink-0"
      ...
      <div className="flex bg-slate-100 hover:bg-slate-250/60 p-1 rounded-2xl max-w-md mb-6 print:hidden transition-colors">
        <button
          ...
          className={`flex-1 py-1.5 px-3 rounded-xl text-xs font-black uppercase text-center transition-all cursor-pointer ${
            stockSubView === "tabela" 
              ? "bg-white text-[#3b82f6] shadow-xs font-black animate-pulse-subtle" 
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-3xs p-4 mb-6 print:hidden">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            ...
            <button
              type="button"
              onClick={handleOpenNewCountSelector}
              className="inline-flex items-center gap-1 bg-[#3b82f6] hover:bg-pink-600 text-white rounded-lg px-2.5 py-1 text-xs font-black uppercase shadow-xs transition-colors cursor-pointer text-xs"
            >
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs bg-slate-50/50 rounded-xl p-3 border border-slate-150/70 mb-3">
                    ...
                    <div>
                      ...
                      <span className="text-[#3b82f6] font-extrabold text-[14.5px] mt-1 block">{stats.perColab} un/colab</span>
                    </div>
                    <div>
                  ...
                  <div className="bg-[#3b82f6]/5 border border-[#3b82f6]/15 rounded-xl p-3 mb-3">
                    <span className="text-xs font-black uppercase text-[#0f172a] tracking-wider block mb-2 border-b border-[#3b82f6]/15 pb-1 select-none">
                        ...
                        return (
                          <div className="flex flex-col gap-2">
                            {cardAttentionItems.map(it => {
                              ...
                              const badgeBg = isConsumo ? "bg-rose-50 text-[#3b82f6] border-rose-100" 
                              ...
                              return (
                                <div key={it.name} className="border-b border-dashed border-slate-150 pb-1.5 last:border-b-0 last:pb-0">
                                  <div className="flex items-center justify-between text-xs leading-none mb-1">
                                    ...
                                    <span className={`font-mono font-black rounded-sm px-1 leading-none ${val === 0 ? "bg-rose-100 text-[#3b82f6] font-black" : "bg-slate-100/95 text-[#0f172a]"}`}>
                                      {val}
                                    </span>
                                  </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between pb-3.5 border-b border-slate-200 gap-2 mb-4 print:mb-2 text-slate-800">
          <div>
            <h3 className="text-sm md:text-[15px] font-black uppercase text-slate-900 tracking-wider flex items-center gap-2">
              ...
              <span className="text-[#3b82f6] font-black bg-pink-50 border border-pink-100 rounded-lg px-2.5 py-1 text-xs">{activeCategory.name.toUpperCase()}</span>
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0 print:hidden">
            <button
              type="button"
              onClick={handleOpenNewCountSelector}
              className="inline-flex items-center gap-1.5 rounded-xl bg-[#0f172a] hover:bg-slate-800 text-white px-3 py-1.5 text-xs font-black uppercase tracking-wider shadow-sm transition-all active:scale-95 cursor-pointer leading-none"
                ...
                <table className="w-full border-collapse text-left text-slate-700">
                  <thead>
                    <tr className="border-b border-slate-300 bg-slate-50/80 font-black uppercase text-slate-900 tracking-tight print:bg-slate-100">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-center gap-1">
                              <span className="block text-[#3b82f6] font-black text-[11.5px]">{m.date}</span>
                              <button
                                type="button"
                                onClick={() => {
                                  setDeleteConfirmMeasurement({ id: m.id, date: m.date });
                      ...
                      {draftMeasurement && (
                        <th className={`${cellPaddingClass} text-center border-l-2 border-dashed border-[#3b82f6] bg-rose-50/20 min-w-[150px] transition-all`}>
                          <div className="flex flex-col items-center gap-1">
                            <div className="flex items-center gap-1.5 bg-white border border-[#3b82f6] rounded-lg px-2 py-1 shadow-3xs">
                              <Calendar className="h-3 w-3 text-[#3b82f6] shrink-0 animate-pulse" />
                              <input
                                type="text"
                      ...
                      {stockSubView === "tabela" && reportMeasurements.length >= 2 && (
                        <th className={`${cellPaddingClass} text-center border-l border-indigo-150 min-w-[125px] w-[125px] transition-all duration-300 ${
                          ...
                          <span className="block text-[#3b82f6] font-black text-[11.5px]">{nextScheduledInfo.dateStr}</span>
                      ...
                      {reportMeasurements.length >= 2 && (
                        <th className={`${cellPaddingClass} text-center bg-[#0f172a] text-white border-l border-slate-300 min-w-[120px] w-[120px] transition-all duration-300 ${
                      ...
                      {reportMeasurements.length >= 2 && (
                        <th className={`${cellPaddingClass} text-center bg-[#0f172a] text-white border-l border-slate-300 min-w-[145px] w-[145px] transition-all duration-300 ${
                          ...
                          <span className="block text-xs font-extrabold text-[#3b82f6] mt-0.5">Consumo Per Capita</span>
                          <div className="flex flex-col sm:flex-row items-center justify-center gap-1 mt-1.5 px-0.5 print:hidden">
                            <button
                              type="button"
                        ...
                        <tr key={it.id} className="hover:bg-slate-55/40 transition-colors leading-normal group">
                          <td className={`${cellPaddingClass} ${nameTextClass} font-bold text-slate-900 transition-all duration-300 ${
                            ...
                            <div className="flex items-center justify-between gap-1.5 select-text">
                              <span className="truncate group-hover:text-[#3b82f6] transition-colors" title={it.name}>
                                {it.name}
                              </span>
                              <div className="flex items-center gap-1">
                                <button
                                  ...
                                  className="inline-flex items-center justify-center h-4.5 w-4.5 rounded bg-pink-50 hover:bg-[#3b82f6] hover:text-white text-[#3b82f6] border border-pink-100/50 font-extrabold text-xs shadow-3xs cursor-pointer active:scale-90 transition-all select-none print:hidden shrink-0"
                          ...
                          {draftMeasurement && (
                            <td className={`${cellPaddingClass} text-center font-mono font-bold bg-rose-50/5 border-l-2 border-dashed border-[#3b82f6]/30 min-w-[150px]`}>
                              <div className="flex items-center justify-center">
                                <input
                                  ...
                                  className="w-20 text-center text-xs font-bold font-mono bg-white border border-slate-200 hover:border-pink-300 focus:border-[#3b82f6] focus:ring-1 focus:ring-[#3b82f6] rounded px-1 py-0.5"
                                />
                              </div>
                            </td>
                          )}
                              ...
                              <td className={`${cellPaddingClass} ${numTextClass} text-center font-mono font-black transition-all duration-300 ${
                                ...
                                {mPenultimate ? (
                                  <div className="flex flex-col items-center justify-center p-1 select-text">
                                    ...
                                    {crit.isCritical && (
                                      <span 
                                        className="text-xs font-black text-white bg-[#3b82f6] px-1.5 py-0.5 rounded mt-1 shadow-2xs text-center block max-w-[100px] break-words uppercase animate-pulse leading-none shrink-0"
          ...
          <div className="modal-scroll-area-parent bg-slate-100 rounded-[24px] border border-slate-205 shadow-md max-w-3xl w-full flex flex-col max-h-[90vh] overflow-hidden p-6 relative">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-rose-50 shrink-0 mb-4 bg-white -m-6 p-6 rounded-t-[24px]">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-sm font-black uppercase text-[#0f172a] tracking-wide leading-none">
                    Estatísticas Dedicadas de Consumo
                  </h2>
                  <p className="text-xs text-slate-500 font-bold mt-1.5">
                    Histórico detalhado p/ o item: <strong className="text-[#3b82f6] font-black">{selectedItemStatsPopup.name}</strong>
                  </p>
                </div>
              </div>
              <button 
              ...
              {sortedMeasurements.length === 0 ? (
                ...
                <>
                  ...
                  {(() => {
                    ...
                    const isConsumo = status === "consumo";
                    const isMantido = status === "mantido";
                    const badgeBg = isConsumo ? "bg-rose-100 text-[#3b82f6] border-rose-250 animate-pulse" 
                    ...
                    return (
                      <div className="bg-white border-2 border-[#3b82f6]/40 rounded-2xl p-4.5 mb-5 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4 transition-all hover:border-[#3b82f6]/60">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100">
                          <div className="flex items-center gap-2 min-w-0">
                            <span className="h-2 w-2 rounded-full bg-[#3b82f6] shrink-0" />
                            <span className="text-xs font-black text-[#0f172a] font-mono truncate">
                              {idx + 1}ª Medição ({m.date})
                            </span>
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 text-xs bg-slate-50/50 rounded-xl p-3 border border-slate-150 mb-1">
                          ...
                          <div>
                            ...
                            {isFirst ? (
                              ...
                              <span className="text-[#3b82f6] font-black text-xs mt-1 block uppercase">
                                -{delta} un (Consumo)
                              </span>
                            ) : delta < 0 ? (
                          ...
                          <div>
                            ...
                            <div className="mt-1 flex flex-col gap-0.5">
                              <span className="text-[#0f172a] font-black text-sm font-mono leading-none">
                                {textVal}
                              </span>
            ...
            <div className="mt-4 pt-3 border-t border-slate-200 flex justify-end shrink-0">
              <button
                type="button"
                onClick={() => setSelectedItemStatsPopup(null)}
                className="bg-[#0f172a] hover:bg-slate-800 text-white px-6 py-2.5 text-xs font-black uppercase rounded-full cursor-pointer transition-all active:scale-95 shadow-md hover:shadow-lg"
              >
                Fechar Painel
              </button>
            </div>
          ...
          <div className="bg-white rounded-[24px] border border-slate-150 shadow-md max-w-md w-full flex flex-col p-6 relative">
            ...
            <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-[#3b82f6] hover:bg-[#E01E4F] text-white text-xs font-black uppercase transition-all shadow-md active:scale-95 cursor-pointer animate-pulse"
              >
                Sim, Excluir
              </button>
            </div>
          ...
          <div className="modal-scroll-area-parent bg-white rounded-[24px] border border-slate-100 shadow-md max-w-2xl w-full flex flex-col max-h-[90vh] overflow-hidden p-6 relative">
            ...
            <div className="grid grid-cols-2 gap-4 shrink-0 mb-4 bg-slate-50 border border-slate-150 p-3.5 rounded-xl">
              <div>
                ...
                <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded-lg px-2.5 py-1.5 focus-within:ring-2 focus-within:ring-[#3b82f6]/20">
              ...
              <div>
                ...
                <div className="p-2 bg-white rounded-lg border border-slate-150 text-xs font-black font-mono text-[#2563eb]">
              ...
              {modalItems.length === 0 ? (
                <div className="p-1">
                  <div 
                    ...
                    className="p-8 text-center rounded-2xl border-2 border-dashed border-[#3b82f6]/30 bg-[#f5f5f5] hover:border-[#3b82f6]/40 hover:bg-[#f5f5f5]/10 transition-all cursor-pointer flex flex-col items-center justify-center min-h-[220px] focus:outline-hidden focus:ring-2 focus:ring-[#3b82f6]/20"
                    title="Clique aqui e cole (Ctrl+V) sua lista de itens e quantidades"
                  >
                    <div className="max-w-md mx-auto space-y-3">
                      <div className="h-12 w-12 rounded-full bg-[#f5f5f5] flex items-center justify-center text-[#3b82f6] mx-auto animate-pulse">
                        <FileSpreadsheet className="h-6 w-6" />
                      </div>
                      <div>
                        <p className="text-[#3b82f6] font-black text-xs uppercase tracking-tight">Planilha de Medições Vazia</p>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2.5 px-1 mt-2">
                    <h4 className="text-xs font-black uppercase text-[#3b82f6] tracking-wider flex items-center gap-1">
                      ...
                      <div key={item.id} className="bg-slate-55/70 border border-slate-150 rounded-lg p-2.5 flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-1 bg-white border border-slate-200 rounded px-1.5 py-0.5 shrink-0 max-w-[90px]">
                          <input
                            ...
                            className="w-full text-center border-0 p-0 text-xs font-black text-[#3b82f6] outline-hidden focus:ring-0 leading-none"
                            placeholder="0"
                          />
                        </div>
                      </div>
          ...
          <div className="bg-white rounded-[24px] border border-slate-150 shadow-md max-w-md w-full flex flex-col p-6 relative">
            ...
            <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-[#3b82f6] hover:bg-[#E01E4F] text-white text-xs font-black uppercase transition-all shadow-md active:scale-95 cursor-pointer"
              >
                Sim, Excluir
              </button>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-black text-slate-800 focus:outline-hidden focus:ring-2 focus:ring-[#3b82f6]/30 transition-all cursor-pointer"
                >
                  {categories.map((cat) => (
                    <option key={cat.id} value={cat.id}>
                      {cat.name.toUpperCase()}
                ...
                return (
                  <div className={`p-4 rounded-xl border text-xs leading-relaxed ${
                    exists 
                      ...
                      : "bg-[#f5f5f5] border-[#3b82f6]/10 text-[#0f172a]"
                  }`}>
                    {exists ? (
                      ...
                      <div className="flex gap-2">
                        <span className="text-sm shrink-0">✨</span>
                        <div>
                          <strong className="block font-black text-xs uppercase tracking-wide text-[#0f172a]">
                            Primeiro registro de contagem!
                          </strong>
                          <span className="font-bold text-xs text-[#0f172a] mt-1 block">
