...
const STYLE_PALETTE = [
  {
    ...
    cellBg: "bg-[#ff2a6d]/5",
    inputBorder: "focus-within:border-[#ff2a6d] focus-within:ring-cyan-50",
      ...
      <div className="border-b border-slate-150 bg-slate-50/50 p-3 flex flex-wrap gap-3 items-center justify-between print:hidden rounded-t-2xl">
        ...
        >
          ...
          <div className="flex items-center gap-1 shrink-0">
            <span className="text-[9px] font-black text-slate-500 uppercase tracking-tighter">Qtd:</span>
            <input
              type="number"
              min={1}
              value={quickQty}
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full border border-pink-100 bg-pink-50 hover:bg-[#ff2a6d] hover:text-white text-[#ff2a6d] px-3.5 py-1.5 font-black shadow-3xs transition-all cursor-pointer text-[10px] uppercase shrink-0"
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full border border-slate-900 bg-slate-900 text-white hover:bg-[#ff2a6d] hover:border-[#ff2a6d] px-3.5 py-1.5 font-black shadow-3xs transition-all cursor-pointer text-[10px] uppercase group"
        >
        ...
        <div className="p-4 border-b border-slate-200 bg-amber-50/20 text-slate-700 font-sans leading-relaxed text-[11px] space-y-3 animate-fade-in print:hidden">
          ...
          <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4 pt-1 text-[11px]">
            <div className="p-3 bg-white border border-slate-200 rounded-xl shadow-3xs hover:border-[#ff2a6d]/30 transition-all">
              <span className="block font-black text-[#ff2a6d] uppercase text-[9.5px] tracking-wider mb-1">📋 Preenchimento em Lote</span>
            ...
            <div className="p-3 bg-white border border-slate-200 rounded-xl shadow-3xs hover:border-[#ff2a6d]/30 transition-all">
              <span className="block font-black text-[#ff2a6d] uppercase text-[9.5px] tracking-wider mb-1">📂 Importar com Excel</span>
              <p className="text-slate-500 leading-normal font-semibold">
            ...
            <div className="p-3 bg-white border border-slate-200 rounded-xl shadow-3xs hover:border-[#ff2a6d]/30 transition-all">
              <span className="block font-black text-[#ff2a6d] uppercase text-[9.5px] tracking-wider mb-1">🔍 Cadastro & Autocomplete</span>
              <p className="text-slate-500 leading-normal font-semibold">
            ...
            <div className="p-3 bg-white border border-slate-200 rounded-xl shadow-3xs hover:border-[#ff2a6d]/30 transition-all">
              <span className="block font-black text-[#ff2a6d] uppercase text-[9.5px] tracking-wider mb-1">💬 Integração WhatsApp</span>
              <p className="text-slate-500 leading-normal font-semibold">
                    ...
                    <div className="flex flex-col items-center justify-between w-full min-h-[76px] select-none py-1.5 mx-auto">
                      ...
                      <div className="mt-1.5 text-[11px] md:text-[11.5px] print:text-[10px] font-black uppercase text-slate-650 flex flex-wrap gap-x-1.5 gap-y-0.5 items-center justify-center leading-none">
                        ...
                        {!s.phone && !s.vendedor && (
                          <span 
                            onClick={() => setSelectedSupplierToEdit(s)}
                            className="text-slate-500 text-[10px] md:text-[10.5px] font-bold lowercase tracking-wider block leading-none select-none hover:text-[#ff2a6d] cursor-pointer"
                          >
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-fade-in print:hidden">
      <div className="bg-white rounded-[24px] border border-slate-100 shadow-2xl max-w-md w-full overflow-hidden p-6 relative">
        ...
        <div className="mb-4">
          <span className="text-[10px] font-black uppercase text-[#ff2a6d] block mb-1">
            Referência do Item:
          </span>
        ...
        <div className="p-5 flex-1 overflow-y-auto space-y-4 max-h-[75vh]">
          ...
          {msgType === "order" && (
            <div className="flex flex-col space-y-1">
              <label className="text-[8px] font-black uppercase tracking-widest text-[#ff2a6d] leading-none">
          ...
          <div className="bg-slate-55 p-3 rounded-xl text-[10px] font-semibold text-slate-600 flex flex-wrap gap-4 items-center border border-slate-150">
            <div>
              <span className="font-bold text-slate-500 block uppercase text-[8px] tracking-tight leading-none mb-1">Destinatário:</span>
            ...
            {msgType === "order" && activeSupplier?.phone && (
              <div>
                <span className="font-bold text-slate-500 block uppercase text-[8px] tracking-tight leading-none mb-1">Telefone:</span>
                <span className="font-mono text-slate-850 font-bold">📞 {activeSupplier.phone}</span>
              </div>
            )}
            {msgType === "order" && activeSupplier?.vendedor && (
              <div>
                <span className="font-bold text-slate-500 block uppercase text-[8px] tracking-tight leading-none mb-1">Vendedor AC:</span>
      ...
      <div className="bg-white rounded-2xl border border-slate-205 shadow-2xl max-w-md w-full overflow-hidden flex flex-col font-sans">
        ...
        <form onSubmit={handleFormSubmit} className="p-5 flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-1 relative" ref={dropdownRef}>
            <label className="text-[8px] font-black uppercase tracking-widest text-[#ff2a6d] block leading-none">
            ...
            <div className="relative">
              ...
              {isAutocompleteOpen && (
                <div className="absolute left-0 right-0 top-full mt-1 bg-white border border-slate-200 rounded-lg shadow-xl z-50 overflow-hidden divide-y divide-slate-100 max-h-40 overflow-y-auto">
                  <div className="p-1 text-[7.5px] font-black tracking-wider text-slate-500 bg-slate-50 uppercase">
                  ...
                  {filteredSuggestions.length > 0 ? (
                    filteredSuggestions.map((ks, index) => (
                      ...
                      >
                        ...
                        {(ks.phone || ks.vendedor) && (
                          <div className="text-[7.5px] text-slate-500 mt-0.5 font-medium flex items-center gap-1.5">
                    ...
                    <div className="p-2 text-center text-slate-500 italic text-[9.5px]">
          ...
          <div className="flex items-center justify-between leading-none">
            <span className="text-[8.5px] font-black uppercase tracking-wider text-[#ff2a6d]">
